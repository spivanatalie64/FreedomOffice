...
# =====================================================================================================================
# ===                   The Access2Base library is a part of the FreedomOffice project.                               ===
# ===                   Full documentation is available on https://access2base.freedomoffice.org                      ===
# =====================================================================================================================
...
Additionally, if Python and FreedomOffice are started in separate processes:
    If FreedomOffice started from console ... (example for Linux)
...
Specific documentation about Access2Base and Python:
    https://access2base.freedomoffice.org/index.html#%5B%5BAccess2Base%20and%20Python%5D%5D
"""
...
def A2BConnect(hostname = '', port = 0):
    """
    To be called explicitly by user scripts when Python process runs outside the FreedomOffice process.
        FreedomOffice started as (Linux):
    ...
    # Determine COMPONENTCONTEXT, via socket or inside FreedomOffice
    if len(hostname) > 0 and port > 0:      # Explicit connection request via socket
        ...
        try:
            ...
            raise ConnectionError('Connection to FreedomOffice failed (host = ' + hostname + ', port = ' + str(port) + ')')
...
class _A2B(object, metaclass = _Singleton):
    ...
    def invokeMethod(cls, script, module, *args):
        ...
        if COMPONENTCONTEXT is None:
            A2BConnect()     #   Connection from inside FreedomOffice is done at first API invocation
