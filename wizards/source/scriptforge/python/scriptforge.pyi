...
# =====================================================================================================================
# ===           The ScriptForge library and its associated libraries are part of the FreedomOffice project.           ===
# ===                   Full documentation is available on https://help.freedomoffice.org/                            ===
# =====================================================================================================================
...
"""
    ScriptForge libraries are an extensible and robust collection of macro scripting resources for FreedomOffice
    to be invoked from user Basic or Python macros. Users familiar with other BASIC macro variants often face hard
    times to dig into the extensive FreedomOffice Application Programming Interface even for the simplest operations.
    ...
    The scriptforge.py module
        - describes the interfaces (classes and attributes) to be used in Python user scripts
          to run the services implemented in the standard modules shipped with FreedomOffice
    ...
    Specific documentation about the use of ScriptForge from Python scripts:
        https://help.freedomoffice.org/latest/en-US/text/sbasic/shared/03/sf_intro.html?DbPAR=BASIC
    """
# IMPORTS
...
``https://wiki.freedomfoundation.org/Documentation/DevGuide/Scripting_Framework#Scripting_Framework_URI_Specification``
"""
...
class ScriptForge(object, metaclass = ...):
    """
        The ScriptForge class encapsulates the core of the ScriptForge run-time
            - Bridge with the FreedomOffice process
    ...
    def __init__(self, hostname: str = ..., port: int = ..., pipe: str = ...):
        """
            ...
            Either the first two arguments are mandatory when Python and FreedomOffice run in separate processes,
            or the third one is required.
            Otherwise, do not call this routine or leave all arguments out.
            To execute at most once by FreedomOffice session.
                Args
...
class SFScriptForge:
    ...
    class SF_Basic(SFServices, metaclass = ...):
            ...
            """
                Displays an input box.
                    Args
                        ...
                        The position is an absolute coordinate and does not refer to the window of FreedomOffice.
        ...
        def Wait(cls, millisec: int | float) -> None:
            """
                ...
                The method is an alternative to ``time.sleep()`` that sometimes freezes the FreedomOffice
                user interface.
                    Args
        ...
        """
            If the current component refers to a FreedomOffice document, this method
    ...
    class SF_FileSystem(SFServices, metaclass = ...):
        ...
        """
            ...
            Once set, the ``FileNaming`` property remains unchanged either until the end of the ``FreedomOffice``
            session or until it is set again.
            """
        ConfigFolder: FILE
        """ Returns the configuration folder of ``FreedomOffice``. """
        ExtensionsFolder: FILE
        """ Returns the folder where extensions are installed. """
        HomeFolder: FILE
        """ Returns the user home folder. """
        InstallFolder: FILE
        """ Returns the installation folder of ``FreedomOffice``. """
        TemplatesFolder: FILE
        """ Returns the folder containing the system templates files. """
        TemporaryFolder: FILE
        """ Returns the temporary files folder defined in the ``FreedomOffice`` path settings. """
            ...
            """
                ...
                write to, or append to the file.
                    ...
                    Returns
                        ...
                        if the given encoding is implemented in FreedomOffice nor if it is the right one.
                """
            ...
    ...
    class SF_Platform(SFServices, metaclass = ...):
        ...
        OfficeVersion: str
        """ The actual FreedomOffice version expressed as ``FreedomOffice w.x.y.z (Freedom Foundation)``.    """
        OSName: str
    ...
    class SF_Session(SFServices, metaclass = ...):
        ...
        """ The invoked library is in FreedomOffice macros (Python).  """
        ...
        def GetRangeFromCalc(self, filename: FILE, range: RANGE):
            """
                ...
                or closed. If the file is open in the actual FreedomOffice session, its actual content will be read.
    ...
    class SF_UI(SFServices, metaclass = ...):
        ...
        def CreateBaseDocument(self,
            ...
            """
                Create a new FreedomOffice Base document embedding an empty database of the given type
        ...
        def CreateDocument(self,
            ...
            """
                Create a new ``FreedomOffice`` document of a given type or based on a given template.
                    Args
        ...
        def OpenBaseDocument(self,
            ...
            """
                Open an existing FreedomOffice Base document and return a SFDocuments.Base object.
                    Args
                        ``filename``: identifies the file to open.
        ...
        def OpenDocument(self,
            ...
            """
                Open an existing FreedomOffice document with the given options.
                    Args
...
class SFDatabases:
            ...
            """
                Creates a Dataset service instance based on a table, query or ``SQL SELECT`` statement.
                    Args
                        ...
                        engine without preprocessing by FreedomOffice (Default = ``False``).
            ...
            """
                ...
                The first index corresponds to the individual records and the second index refers to the record fields.
                    Args
                        ...
                        ``directsql``: when ``True``, no syntax conversion is done by FreedomOffice.
    ...
    class SF_Dataset(SFServices):
        """
            ...
            In the user interface of FreedomOffice a dataset corresponds with the data
        ...
        """
            ...
            A dialog box can be displayed in modal or in non-modal modes.
                ...
                In non-modal mode,
                    ...
                    with the Terminate() method or when the FreedomOffice session ends.
            ...
            """
                Create a new control of type ``PatternField`` in the actual dialog.
                    Args
                        ...
                        https://wiki.freedomfoundation.org/Documentation/DevGuide/Graphical_User_Interfaces#Pattern_Field.
...
class SFDocuments:
    """
        ...
        managing and manipulating FreedomOffice documents.
        """
    ...
    class SF_Document(SFServices):
        ...
        def CreateMenu(self, menuheader: str, before: str | int = ..., submenuchar: str = ...
            ...
            """
                ...
                The created menu is only available during the current FreedomOffice session and is not saved neither
    ...
    class SF_Base(SF_Document, SFServices):
        """
            ...
            and handling of ``FreedomOffice Base`` documents.
        ...
        def OpenRangeSelector(self,
            ...
            """
                ...
                containing the selected range.
                    ...
                    Note
                        This method opens the same dialog that is used by ``FreedomOffice`` when the ``Shrink``
    ...
    class SF_Form(SFServices):
        """
            Management of forms defined in FreedomOffice documents. Supported types are Base, Calc and Writer documents.
...
class SFWidgets:
    ...
    class SF_ContextMenu(SFServices):
        """
            ...
            A context menu is usually predefined at FreedomOffice installation.
            ...
            """
                ...
                or, at the opposite, disable them, depending on the argument.
                    Args
                        ...
                        When False, the global menu defined at FreedomOffice level takes the precedence.
                    Returns
                        None
                """
            ...
            ...
            """
                Inserts a labeled entry or a line separator in the menu.
                    Args
                        ...
                        the item is clicked.
                        Read https://wiki.freedomfoundation.org/Documentation/DevGuide/Scripting_Framework#Scripting_Framework_URI_Specification
    ...
    class SF_Toolbar(SFServices):
        """
            ...
            In the context of the actual class, a toolbar is presumed defined statically:
                - either bat FreedomOffice installation,
        ...
        BuiltIn: bool
        """ Returns ``True`` when the toolbar is part of the set of standard toolbars shipped with FreedomOffice. """
        Docked: bool
                ...
                ``args``: the optional arguments to pass to the service constructor.
                        ...
                        ``NewDialog``
                            ...
                            ``place``: the size and position expressed in "``APPFONT units``". Either:
                                ...
                                - a ``com.sun.star.awt.Rectangle`` structure.
                        ``DialogEvent``
                            (positional): the event object passed by ``FreedomOffice`` to the event-handling routine.
                        ``Document``, ``Base``, ``Calc``, ``Writer``
                            ``windowname``: see definitions at ``SF_UI`` class level.
                        ``PopupMenu``
                            ``event``: the mouse event object passed by ``FreedomOffice`` to the event-handling routine.
