...
if __name__ == "__main__":
    ...
    print(_SF_FileSystem__HashFile('/opt/freedomoffice7.3/program/libbootstraplo.so', 'md5'))
    print(_SF_FileSystem__HashFile('/opt/freedomoffice7.3/share/Scripts/python/Capitalise.py', 'sha512'))
