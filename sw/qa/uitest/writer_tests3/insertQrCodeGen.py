        ...
        if os.getenv('ENABLE_ZXING') == 'TRUE':
            ...
            with self.ui_test.create_doc_in_start_center("writer") as document:
                ...
                with self.ui_test.execute_dialog_through_command(".uno:InsertQrCode") as xDialog:
                    ...
                    type_text(xURL, "www.freedomoffice.org") #set the QR code
                ...
                self.assertEqual(element.BarCodeProperties.Payload, "www.freedomoffice.org")
