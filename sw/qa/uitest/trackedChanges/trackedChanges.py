...
from org.freedomoffice.unotest import systemPathToFileUrl
import os.path
...
class trackedchanges(UITestCase):
    ...
    def test_tracked_changes_accept(self):
        ...
        with self.ui_test.create_doc_in_start_center("writer") as document:
            ...
            self.xUITest.executeCommand(".uno:TrackChanges")
            type_text(xWriterEdit, "Test FreedomOffice")
            ...
            self.assertEqual(document.Text.String[0:16], "Test FreedomOffice")
    ...
    def test_tracked_changes_zprev_next(self):
        ...
        with self.ui_test.create_doc_in_start_center("writer") as document:
            ...
            self.assertEqual(document.Text.String[0:37], "Test FreedomOffice Test2 Test3 Test4")
            ...
            self.xUITest.executeCommand(".uno:RejectTrackedChange")
            self.assertEqual(document.Text.String[0:30], "Test FreedomOffice Test2 Test4")
