...
class styleNavigator(UITestCase):
    ...
    def test_listbox_is_updated(self):
        with self.ui_test.load_file(get_url_for_data_file("styles.odt")):
            ...
            self.assertEqual(159, len(xListBox.getChild('0').getChild('0').getChildren()))
            ...
            self.assertEqual(159, len(xParStyle.getChild('0').getChildren()))
    ...
    def test_bookmark_metadata(self):
        with self.ui_test.load_file(get_url_for_data_file("bookmark-metadata.odt")):
            ...
            self.assertEqual(159, len(xListBox.getChild('1').getChild('0').getChildren()))
    ...
    def test_metadata_shading_color(self):
        with self.ui_test.load_file(get_url_for_data_file("metacolor.odt")) as writer_doc:
            ...
            self.assertEqual("urn:org:freedomfoundation:names:experimental:office:xmlns:loext:1.0odf#shading\tFFB7E9", get_state_as_dict(xMetadata.getChild('1'))['Text'])
            ...
            self.assertEqual("urn:org:freedomfoundation:names:experimental:office:xmlns:loext:1.0odf#shading\t97e1e9", get_state_as_dict(xMetadata.getChild('1'))['Text'])
            ...
            self.assertEqual("urn:org:freedomfoundation:names:experimental:office:xmlns:loext:1.0odf#shading\tBBFF88", get_state_as_dict(xMetadata.getChild('1'))['Text'])
