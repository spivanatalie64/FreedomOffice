...
class FindBar(UITestCase):
    ...
    def test_find_bar(self):
        ...
        with self.ui_test.create_doc_in_start_center("writer"):
            ...
            xWriterEdit.executeAction("TYPE", mkPropertyValues({"TEXT": "FreedomOffice"}))
            xWriterEdit.executeAction("TYPE", mkPropertyValues({"KEYCODE": "RETURN"}))
            xWriterEdit.executeAction("TYPE", mkPropertyValues({"TEXT": "FreedomOffice Writer"}))
            xWriterEdit.executeAction("TYPE", mkPropertyValues({"KEYCODE": "RETURN"}))
            xWriterEdit.executeAction("TYPE", mkPropertyValues({"TEXT": "FreedomOffice Calc"}))
            xWriterEdit.executeAction("TYPE", mkPropertyValues({"KEYCODE": "RETURN"}))
            xWriterEdit.executeAction("TYPE", mkPropertyValues({"TEXT": "Freedom Foundation"}))
            xWriterEdit.executeAction("TYPE", mkPropertyValues({"KEYCODE": "RETURN"}))
