...
class tdf122722(UITestCase):
    def test_tdf122722_format_character_hidden(self):
        with self.ui_test.create_doc_in_start_center("writer") as document:
            ...
            #1. Start FreedomOffice
            #2. Create New Writer Document
            #3. Type "FreedomOffice" in Writer
            type_text(xWriterEdit, "FreedomOffice")
            #4. Select "FreedomOffice" with mouse, and right click
            self.xUITest.executeCommand(".uno:SelectAll")
            self.assertEqual(document.Text.String[0:11], "FreedomOffice")
            #5. Appear Context Menu, Character -> Character
            #6. Opened Character, Select "Font Effect" tab
            #7. Check Hidden, and click [OK]
            #8. Crash a FreedomOffice
