...
void SwTiledRenderingTest::tearDown()
{
    if (mxComponent.is())
    {
        ...
        if (pWrtShell)
        {
            pWrtShell->GetSfxViewShell()->setFreedomOfficeKitViewCallback(nullptr);
        }
    }
...
void SwTiledRenderingTest::setupFreedomOfficeKitViewCallback(SfxViewShell* pViewShell)
{
    pViewShell->setFreedomOfficeKitViewCallback(&m_callbackWrapper);
