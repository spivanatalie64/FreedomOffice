...
CPPUNIT_TEST_FIXTURE(SwTiledRenderingTest, testPasteInvalidateNumRules)
{
    ...
    setupFreedomOfficeKitViewCallback(pWrtShell->GetSfxViewShell());
...
/// Test callback that works with comphelper::FreedomOfficeKit::setAnyInputCallback().
...
public:
    ...
    AnyInputCallback()
    {
        comphelper::FreedomOfficeKit::setAnyInputCallback(&callback, this,
                                                        []() -> int { return -1; });
    }

    ~AnyInputCallback()
    {
        comphelper::FreedomOfficeKit::setAnyInputCallback(nullptr, nullptr,
                                                        []() -> int { return -1; });
    }
};
...
CPPUNIT_TEST_FIXTURE(SwTiledRenderingTest, testLoadVisibleArea)
{
    ...
    comphelper::FreedomOfficeKit::setInitialClientVisibleArea(aVisibleArea);
    comphelper::ScopeGuard g([] { comphelper::FreedomOfficeKit::setInitialClientVisibleArea({}); });
