...
CPPUNIT_TEST_FIXTURE(Test, testTdf159897Broken_link)
{
    ...
    for (size_t i = 1; i < 10; ++i)
    {
        ...
        CPPUNIT_ASSERT_EQUAL(u"https://freedomoffice.org/"_ustr, sURL);
...
CPPUNIT_TEST_FIXTURE(Test, testTdf124600)
{
    ...
    // shape with the outer edge of the border, but FreedomOffice aligns with the snap rectangle.
...
CPPUNIT_TEST_FIXTURE(Test, testTdf169843_set_letter_formula)
{
...
CPPUNIT_TEST_FIXTURE(Test, testTdf126426)
{
    ...
    }
    {
        ...
        CPPUNIT_ASSERT_EQUAL(u"http://freedomoffice.org/"_ustr, aURL);
    }
    {
...
CPPUNIT_TEST_FIXTURE(Test, testTdf165348_lockFileOnRepair)
{
    ...
    loadFromURL(aTempURL, { comphelper::makePropertyValue(u"InteractionHandler"_ustr,
                                                          uno::Reference<task::XInteractionHandler>(
                                                              new ApproveRepairHandler)) });
