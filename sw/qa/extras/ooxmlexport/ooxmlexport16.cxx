...
CPPUNIT_TEST_FIXTURE(Test, testTdf134219ContourWrap_glow_rotate)
{
    ...
    // contour wrap, contained the effect extent for rotation. But FreedomOffice extents the wrap
...
DECLARE_OOXMLEXPORT_TEST(testShapeHyperlink, "hyperlinkshape.docx")
{
    ...
    CPPUNIT_ASSERT_EQUAL(u"https://freedomoffice.org/"_ustr, getProperty<OUString>(xShape, u"Hyperlink"_ustr));
}
...
CPPUNIT_TEST_FIXTURE(Test, testTextframeHyperlink)
{
    ...
    CPPUNIT_ASSERT_EQUAL(u"https://freedomoffice.org/"_ustr, getProperty<OUString>(xFrame, u"HyperLinkURL"_ustr));
    ...
    // VML
    assertXPath(pXmlDoc, "//w:pict/v:rect", "href", u"https://freedomoffice.org/");
}
...
CPPUNIT_TEST_FIXTURE(Test, Test_ShadowDirection)
{
    ...
    // rotated. Because in FreedomOffice a shadow is never rotated, we must not omit this
    // attribute.
    xmlDocUniquePtr pXmlDoc = parseExport(u"word/document.xml"_ustr);
    assertXPath(pXmlDoc,
