...
{
    //The problem was freedomoffice crash while opening the file.
    getParagraph(1,u"Contents"_ustr);
}

DECLARE_OOXMLEXPORT_TEST(testFdo72560, "fdo72560.docx")
{
    // The problem was freedomoffice confuse when there RTL default style for paragraph
...
{
    // The problem was freedomoffice confuse when RTL was specified in non-default style
...
{
    // The problem was freedomoffice confuse when RTL was specified in DocDefaults
    uno::Reference<uno::XInterface> xParaEndRTL(getParagraph( 2, u"RTL END"_ustr));
    CPPUNIT_ASSERT_EQUAL(text::WritingMode2::RL_TB, getProperty<sal_Int16>( xParaEndRTL, u"WritingMode"_ustr ));
    CPPUNIT_ASSERT_EQUAL( sal_Int32(style::ParagraphAdjust_END), getProperty< sal_Int32 >( xParaEndRTL, u"ParaAdjust"_ustr ));
}
...
{
    // The problem was freedomoffice confuse when RTL was specified in "Normal" when not using Normal at all
...
{
    // The problem was freedomoffice confuse when *locale* is RTL, but w:bidi / w:jc are never defined.
...
DECLARE_OOXMLEXPORT_TEST(testFreedomOfficeHang, "frame-wrap-auto.docx")
{
    // fdo#72775
