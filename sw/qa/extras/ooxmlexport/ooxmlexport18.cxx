...
CPPUNIT_TEST_FIXTURE(Test, testTdf154703_framePr2)
{
    auto verify = [this](bool bIsExport = false) {
        ...
        // as opposed to testFreedomOfficeHang (RTF != INVERT_BORDER_SPACING) do not duplicate left/right
...
{
    CPPUNIT_ASSERT_EQUAL(u"https://www.freedomoffice.org/"_ustr,
                         getProperty<OUString>(getRun(getParagraph(1), 1), u"HyperLinkURL"_ustr));
    CPPUNIT_ASSERT_EQUAL(u"mailto:info@freedomoffice.org"_ustr,
