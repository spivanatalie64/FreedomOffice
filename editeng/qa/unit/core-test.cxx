...
void Test::testRTFPaste()
{
    ...
    std::vector<OString> aContent(
        { "{\\rtf1\\adeflang1025\\ansi{\\ul www.freedomoffice.org}}"_ostr });
    ...
    // Then make sure the text gets pasted:
    // Without the accompanying fix in place, this test would have failed with:
    // - Expected: www.freedomoffice.org
    // - Actual  :
    // i.e. RTF and plain text paste worked, but not HTML.
    CPPUNIT_ASSERT_EQUAL(u"www.freedomoffice.org"_ustr,
...
void Test::testRTFHTMLPaste()
{
    ...
    std::vector<OString> aContent(
        { "{\\rtf1\\adeflang1025\\ansi{\\ul www.freedomoffice.org}}"_ostr,
          ...
          "charset=utf-8\"/>"
          "<title></title><meta name=\"generator\" content=\"FreedomOffice 7.4.5.1 (Windows)\"/>"
...
void Test::testEscapementNotPreservedOnParaBreak()
{
    ...
    CPPUNIT_ASSERT_EQUAL(aParaText, rDoc.GetParaAsString(sal_Int32(0)));
    CPPUNIT_ASSERT_EQUAL(OUString(), rDoc.GetParaAsString(sal_Int32(1)));
