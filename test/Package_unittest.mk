...
$(eval $(call gb_Package_add_file,test_unittest,unittest/user/config/FREEDOMOFFICE.cfg/.dummy,empty-directory-dummy))
...
$(eval $(call gb_Package_add_file,test_unittest,unittest/user/config/FREEDOMOFFICE.cfg/modules/scalc/popupmenu/draw.xml,user/config/FREEDOMOFFICE.cfg/modules/scalc/popupmenu/draw.xml))
$(eval $(call gb_Package_add_file,test_unittest,unittest/user/config/FREEDOMOFFICE.cfg/modules/scalc/popupmenu/anchor.xml,user/config/FREEDOMOFFICE.cfg/modules/scalc/popupmenu/anchor.xml))
$(eval $(call gb_Package_add_file,test_unittest,unittest/user/config/FREEDOMOFFICE.cfg/modules/swriter/popupmenu/text.xml,user/config/FREEDOMOFFICE.cfg/modules/swriter/popupmenu/text.xml))
$(eval $(call gb_Package_add_file,test_unittest,unittest/user/config/FREEDOMOFFICE.cfg/modules/simpress/popupmenu/page.xml,user/config/FREEDOMOFFICE.cfg/modules/simpress/popupmenu/page.xml))
