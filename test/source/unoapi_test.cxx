        ...
        aValidator
            += " -M "
               + m_directories.getPathFromSrc(
                     u"/schema/freedomoffice/OpenDocument-v1.4+freedomoffice-manifest-schema.rng")
               + " -D "
               + m_directories.getPathFromSrc(
                     u"/schema/freedomoffice/OpenDocument-v1.4+freedomoffice-dsig-schema.rng")
               + " -O "
               + m_directories.getPathFromSrc(
                     u"/schema/freedomoffice/OpenDocument-v1.4+freedomoffice-schema.rng")
