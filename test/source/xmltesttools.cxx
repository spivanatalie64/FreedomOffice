...
void XmlTestTools::registerODFNamespaces(xmlXPathContextPtr& pXmlXpathCtx)
{
    ...
    xmlXPathRegisterNs(
        ...
        BAD_CAST("urn:org:freedomfoundation:names:experimental:calc:xmlns:calcext:1.0"));
    xmlXPathRegisterNs(
        pXmlXpathCtx, BAD_CAST("loext"),
        BAD_CAST("urn:org:freedomfoundation:names:experimental:office:xmlns:loext:1.0"));
    xmlXPathRegisterNs(
...
void XmlTestTools::registerOOXMLNamespaces(xmlXPathContextPtr& pXmlXpathCtx)
{
    ...
    xmlXPathRegisterNs(pXmlXpathCtx, BAD_CAST("xda"),
                       BAD_CAST("http://schemas.microsoft.com/office/spreadsheetml/2017/dynamicarray"));
}
