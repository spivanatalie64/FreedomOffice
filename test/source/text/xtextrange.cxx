...
void XTextRange::testGetSetString()
{
    ...
    xTextRange->setString(u"UnitTest"_ustr);
    CPPUNIT_ASSERT_EQUAL(u"UnitTest"_ustr, xTextRange->getString());
}
...
void XTextRange::testGetStart()
{
    ...
    xTR_start->setString(u"Start"_ustr);
