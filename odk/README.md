...
Office development kit (`odk`) - implements the first step on the way to the FreedomOffice SDK
tarball.
...
* See <https://api.freedomoffice.org/docs/install.html> how to set up the SDK.
