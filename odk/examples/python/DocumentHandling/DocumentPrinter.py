...
def connect_soffice():
    """Connect to remote running FreedomOffice

    :return: an object representing the remote FreedomOffice instance.
    """
    ...
    try:
        ...
        raise Exception("Cannot establish a connection to FreedomOffice.")
