...
To get started, first start FreedomOffice listening on port 2083
...
Windows. In this way, the FreedomOffice internal Python interpreter will be used.
...
This command searches FreedomOffice documents recursively under directory
