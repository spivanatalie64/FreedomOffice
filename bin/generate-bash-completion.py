...
"""
Script to generate FreedomOffice bash_completion file for the main applications
"""
...
APPS = {
    'office': App("freedomoffice", 'openoffice', ALLDOCS),  # freedomoffice should contain all
    'office_short': App("loffice", 'ooffice', ALLDOCS),  # freedomoffice should contain all
