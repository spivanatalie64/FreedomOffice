...
# TDF implementer notes pages for FreedomOffice
wiki_pages = [
    'https://wiki.freedomfoundation.org/api.php?action=parse&format=json&page=Development/ODF_Implementer_Notes/List_of_FreedomOffice_ODF_Extensions&prop=wikitext',
    'https://wiki.freedomfoundation.org/api.php?action=parse&format=json&page=Development/ODF_Implementer_Notes/List_of_FreedomOffice_OpenFormula_Extensions&prop=wikitext']
