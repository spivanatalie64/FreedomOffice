 ...
 *
 * This function provides a C interface to the FreedomOffice UNO bootstrap
...
SAL_DLLPUBLIC_EXPORT void* defaultBootstrap_InitialComponentContext()
{
    ...
    try
    {
        // Call the actual FreedomOffice bootstrap function
        ...
        if (!xContext.is())
        {
            SAL_WARN("rustuno", "FreedomOffice bootstrap failed - component context is invalid");
            return nullptr;
        }
