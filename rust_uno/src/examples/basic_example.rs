...
//! with FreedomOffice UNO components, including the OUString wrapper for safe
...
pub fn oustring_basic_example() {
    println!("=== FreedomOffice UNO Rust Binding - OUString Demonstration ===");
...
pub fn advanced_string_example() {
    ...
    let hello_string = OUString::from("Hello, FreedomOffice!");
    ...
    let same_hello = OUString::from("Hello, FreedomOffice!");
