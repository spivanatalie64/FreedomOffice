...
//!
//! This module provides the high-level safe Rust wrapper around FreedomOffice's uno_Sequence.
//! It includes automatic memory management and safe conversions to/from Rust values.
//!
//! ## Key Components
//! - `Sequence` - Safe Rust wrapper around FreedomOffice's uno_Sequence
...
/// UNO Sequence wrapper - a safe Rust wrapper around FreedomOffice's uno_Sequence
///
/// Sequence provides a safe, memory-managed interface to FreedomOffice's native
