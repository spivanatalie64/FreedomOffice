...
//!
//! This module provides the high-level safe Rust wrapper around FreedomOffice's rtl_uString.
//! It includes automatic memory management and safe conversions to/from Rust strings.
//!
//! ## Key Components
//! - `OUString` - Safe Rust wrapper around FreedomOffice's rtl_uString
...
/// UNO String wrapper - a safe Rust wrapper around FreedomOffice's rtl_uString
///
/// OUString provides a safe, memory-managed interface to FreedomOffice's native
...
impl OUString {
    ...
    ///
    /// This uses FreedomOffice's direct UTF-8 to UString conversion function,
    ...
    ///
    /// This method uses FreedomOffice's native ASCII conversion function for
    ...
    /// method when you already have UTF-16 data, since FreedomOffice uses UTF-16
