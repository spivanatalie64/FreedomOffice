# FreedomOffice help build

FreedomOffice can build three kinds of help output from helpcontent2:

* XML (local, bundled with FreedomOffice < 6.0)
* HTML (local, bundled with FreedomOffice >= 6.0)
* HTML (online)
...
This type was bundled per-default until FreedomOffice 6.0.
...
help inside bundled extensions, but both are not part of the FreedomOffice SDK.

## HTML help, bundled

This type is bundled per-default since FreedomOffice 6.0 and displayed in a
browser.

## HTML help, online

This help is the external one, currently provided by help.freedomoffice.org. It
