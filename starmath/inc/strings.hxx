...
#define RID_LVECX               u"leftvec <?> "
#define RID_HARPOONX            u"harpoon <?> "
#define RID_LHARPOONX           u"leftharpoon <?> "
...
#define RID_WIDELVECX           u"wideleftvec {<?>} "
#define RID_WIDEHARPOONX        u"wideharpoon {<?>} "
#define RID_WIDELHARPOONX       u"wideleftharpoon {<?>} "
...
#define RID_ADLMEXPX            u"𞤣𞤫𞤱(<?>) "
#define RID_ADLMLNX             u"𞤤𞤬(<?>) "
#define RID_ADLMLOGX            u"𞤤𞤭𞤬(<?>) "
#define RID_ADLMSINX            u"𞤧𞤢𞤤(<?>) "
#define RID_ADLMCOSX            u"𞤸𞤢𞤤(<?>) "
#define RID_ADLMTANX            u"𞤼𞤢𞤳(<?>) "
#define RID_ADLMSECX            u"𞤼𞤢𞤰(<?>) "
#define RID_ADLMCSCX            u"𞤳𞤼𞤢𞤰(<?>) "
#define RID_ADLMCOTX            u"𞤳𞤼𞤢𞤳(<?>) "
#define RID_ADLMARCSINX         u"𞤤𞤧𞤢𞤤(<?>) "
#define RID_ADLMARCCOSX         u"𞤤𞤸𞤢𞤤(<?>) "
#define RID_ADLMARCTANX         u"𞤤𞤼𞤢𞤳(<?>) "
// #define RID_ARCCOTX             u"arccot(<?>) "
#define RID_ADLMSINHX           u"𞤧𞤢𞤤𞤬(<?>) "
#define RID_ADLMCOSHX           u"𞤸𞤢𞤤𞤬(<?>) "
#define RID_ADLMTANHX           u"𞤼𞤢𞤳𞤬(<?>) "
#define RID_ADLMCOTHX           u"𞤳𞤼𞤳𞤬(<?>) "
#define RID_ADLMSECHX           u"𞤼𞤢𞤰𞤬(<?>) "
#define RID_ADLMCSCHX           u"𞤳𞤼𞤰𞤬(<?>) "
// #define RID_ARSINHX             u"arsinh(<?>) "
// #define RID_ARCOSHX             u"arcosh(<?>) "
// #define RID_ARTANHX             u"artanh(<?>) "
// #define RID_ARCOTHX             u"arcoth(<?>) "
#define RID_ADLMLIMX            u"𞤳𞤫𞥅𞤪 <?> "
#define RID_ADLMLIM_FROMX       u"𞤳𞤫𞥅𞤪 from{<?>} <?> "
#define RID_ADLMLIM_TOX         u"𞤳𞤫𞥅𞤪 to{<?>} <?> "
#define RID_ADLMLIM_FROMTOX     u"𞤳𞤫𞥅𞤪 from{<?>} to{<?>} <?> "
#define RID_ADLMLIMINFX         u"𞤳𞤫𞥅𞤪𞤤𞤫𞤧 <?> "
#define RID_ADLMLIMINF_FROMX    u"𞤳𞤫𞥅𞤪𞤤𞤫𞤧 from{<?>} <?> "
#define RID_ADLMLIMINF_TOX      u"𞤳𞤫𞥅𞤪𞤤𞤫𞤧 to{<?>} <?> "
#define RID_ADLMLIMINF_FROMTOX  u"𞤳𞤫𞥅𞤪𞤤𞤫𞤧 from{<?>} to{<?>} <?> "
#define RID_ADLMLIMSUPX         u"𞤳𞤫𞥅𞤪𞤼𞤮𞥅𞤱 <?> "
#define RID_ADLMLIMSUP_FROMX    u"𞤳𞤫𞥅𞤪𞤼𞤮𞥅𞤱 from{<?>} <?> "
#define RID_ADLMLIMSUP_TOX      u"𞤳𞤫𞥅𞤪𞤼𞤮𞥅𞤱 to{<?>} <?> "
#define RID_ADLMLIMSUP_FROMTOX  u"𞤳𞤫𞥅𞤪𞤼𞤮𞥅𞤱 from{<?>} to{<?>} <?> "
// N'ko
#define RID_NKOEX               u"func ߋ^{<?>} "
#define RID_NKOEXPX             u"ߞߎߠߢ(<?>) "
#define RID_NKOLNX              u"ߘߖߛ(<?>) "
#define RID_NKOLOGX             u"ߘߊߖ(<?>) "
#define RID_NKOSINX             u"ߞߡ(<?>) "
#define RID_NKOCOSX             u"ߞߡߢ(<?>) "
#define RID_NKOTANX             u"ߡߕ(<?>) "
#define RID_NKOSECX             u"ߜߘ(<?>) "
#define RID_NKOCSCX             u"ߜߘߢ(<?>) "
#define RID_NKOCOTX             u"ߡߕߢ(<?>) "
#define RID_NKOARCSINX          u"ߞߡߞ(<?>) "
#define RID_NKOARCCOSX          u"ߞߡߢߞ(<?>) "
#define RID_NKOARCTANX          u"ߡߕߞ(<?>) "
// #define RID_ARCCOTX             u"arccot(<?>) "
#define RID_NKOSINHX            u"ߞߡߖ(<?>) "
#define RID_NKOCOSHX            u"ߞߡߢߖ(<?>) "
#define RID_NKOTANHX            u"ߡߕߖ(<?>) "
#define RID_NKOCOTHX            u"ߡߕߢߖ(<?>) "
#define RID_NKOSECHX            u"ߜߘߖ(<?>) "
#define RID_NKOCSCHX            u"ߜߘߢߖ(<?>) "
// #define RID_ARSINHX             u"arsinh(<?>) "
// #define RID_ARCOSHX             u"arcosh(<?>) "
// #define RID_ARTANHX             u"artanh(<?>) "
// #define RID_ARCOTHX             u"arcoth(<?>) "
#define RID_NKOLIMX             u"ߘߠ <?> "
#define RID_NKOLIM_FROMX        u"ߘߠ from{<?>} <?> "
#define RID_NKOLIM_TOX          u"ߘߠ to{<?>} <?> "
#define RID_NKOLIM_FROMTOX      u"ߘߠ from{<?>} to{<?>} <?> "
#define RID_NKOLIMINFX          u"ߘߠߘ <?> "
#define RID_NKOLIMINF_FROMX     u"ߘߠߘ from{<?>} <?> "
#define RID_NKOLIMINF_TOX       u"ߘߠߘ to{<?>} <?> "
#define RID_NKOLIMINF_FROMTOX   u"ߘߠߘ from{<?>} to{<?>} <?> "
#define RID_NKOLIMSUPX          u"ߘߠߛ <?> "
#define RID_NKOLIMSUP_FROMX     u"ߘߠߛ from{<?>} <?> "
#define RID_NKOLIMSUP_TOX       u"ߘߠߛ to{<?>} <?> "
#define RID_NKOLIMSUP_FROMTOX   u"ߘߠߛ from{<?>} to{<?>} <?> "
// clang-format on
