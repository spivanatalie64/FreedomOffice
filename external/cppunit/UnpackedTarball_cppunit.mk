...
# * external/cppunit/order.patch.0 upstreamed at <https://gerrit.freedomoffice.org/c/cppunit/+/123963>
#   "Run tests in deterministic order";
# * external/cppunit/propagate-exceptions.patch.0 upstreamed at
#   <https://gerrit.freedomoffice.org/c/cppunit/+/144074> "Introduce CPPUNIT_PROPAGATE_EXCEPTIONS
#   environment variable";
# * external/cppunit/sprintf.patch.0 upstreamed at
#   <https://gerrit.freedomoffice.org/c/cppunit/+/147383> "Use snprintf instead of sprintf";
# * external/cppunit/clang.patch.0 upstreamed at
#   <https://gerrit.freedomoffice.org/c/cppunit/+/147384> "Don't mis-apply GCC < 4.6 workaround for
#   Clang":
# * external/cppunit/0001-cid-1546460-COPY_INSTEAD_OF_MOVE.patch.1 upstreamed at
#   <https://gerrit.freedomoffice.org/c/cppunit/+/161455> "cid#1546460 COPY_INSTEAD_OF_MOVE";
# * external/cppunit/0001-cid-1660438-Variable-copied-when-it-could-be-moved.patch.1 upstreamed at
#   <https://gerrit.freedomoffice.org/c/cppunit/+/189407> "cid#1660438 Variable copied when it could be moved";
