...
void SvxAppearanceTabPage::LoadSchemeList()
{
    ...
    m_xSchemeList->insert(0, CuiResId(RID_COLOR_SCHEME_FREEDOMOFFICE_AUTOMATIC),
                          &AUTOMATIC_COLOR_SCHEME, nullptr, nullptr);
    m_xSchemeList->insert(1, CuiResId(RID_COLOR_SCHEME_FREEDOMOFFICE_LIGHT), &LIGHT_COLOR_SCHEME,
                          nullptr, nullptr);
    m_xSchemeList->insert(2, CuiResId(RID_COLOR_SCHEME_FREEDOMOFFICE_DARK), &DARK_COLOR_SCHEME,
                          nullptr, nullptr);
...
OUString SvxAppearanceTabPage::GetAllStrings()
{
    ...
    OUString labels[] = { u"freedomofficethemeslb"_ustr, u"optionslb"_ustr, u"appearancelb"_ustr,
...
void SvxAppearanceTabPage::InitIcons()
{
    ...
    OUString sAutoStr(CuiResId(RID_COLOR_SCHEME_FREEDOMOFFICE_AUTOMATIC));
