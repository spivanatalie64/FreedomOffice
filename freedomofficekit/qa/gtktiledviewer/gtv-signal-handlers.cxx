...
{
    // Just convert directly back to the FreedomOfficeKitPartMode enum.
    // I.e. the ordering above should match the enum member ordering.
    FreedomOfficeKitPartMode ePartMode =
        FreedomOfficeKitPartMode( gtk_combo_box_get_active( GTK_COMBO_BOX(pSelector) ) );
    GtvApplicationWindow* window = GTV_APPLICATION_WINDOW(gtk_widget_get_toplevel(pSelector));
