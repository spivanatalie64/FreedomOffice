...
#pragma warning(pop)
    ...
    FreedomOfficeKitDocument* pDocument = lok_doc_view_get_document(LOK_DOC_VIEW(window->lokdocview));
    if (pDocument)
    {
        FreedomOfficeKitDocumentType eDocType = static_cast<FreedomOfficeKitDocumentType>(pDocument->pClass->getDocumentType(pDocument));
...
gtv_application_window_new(GtkApplication* app)
{
    ...
    return GTV_APPLICATION_WINDOW(g_object_new(GTV_TYPE_APPLICATION_WINDOW,
                                               ...
                                               "width-request", 1024,
                                               "height-request", 768,
                                               "title", "FreedomOffice GtkTiledViewer",
