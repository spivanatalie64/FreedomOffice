...
enum
{
    PROP_SUNBURST_TEMPLATE_DIMENSION,
    PROP_SUNBURST_TEMPLATE_GEOMETRY3D
};

void lcl_AddPropertiesToVector(std::vector<Property>& rOutProperties)
{
    rOutProperties.emplace_back(
        "Dimension", PROP_SUNBURST_TEMPLATE_DIMENSION, cppu::UnoType<sal_Int32>::get(),
        beans::PropertyAttribute::BOUND | beans::PropertyAttribute::MAYBEDEFAULT);
    rOutProperties.emplace_back(
        "Geometry3D", PROP_SUNBURST_TEMPLATE_GEOMETRY3D, cppu::UnoType<sal_Int32>::get(),
        beans::PropertyAttribute::BOUND | beans::PropertyAttribute::MAYBEDEFAULT);
}

::cppu::OPropertyArrayHelper& StaticSunburstChartTypeTemplateInfoHelper()
{
...
namespace chart
{
SunburstChartTypeTemplate::SunburstChartTypeTemplate(
...
sal_Int32 SunburstChartTypeTemplate::getDimension() const { return m_nDim; }

// ____ ChartTypeTemplate ____
bool SunburstChartTypeTemplate::matchesTemplate2(const rtl::Reference<::chart::Diagram>& xDiagram,
                                                 bool bAdaptProperties)
{
    ...
    if (bAdaptProperties && bResult && getDimension() == 3)
    {
        ...
        if (!bGeomAmbiguous)
        {
            setFastPropertyValue_NoBroadcast(PROP_SUNBURST_TEMPLATE_GEOMETRY3D,
                                             uno::Any(aCommonGeom));
        }
    }
...
rtl::Reference<ChartType>
    SunburstChartTypeTemplate::getChartTypeForIndex(sal_Int32 /*nChartTypeIndex*/)
{
    return new SunburstChartType();
}

rtl::Reference<ChartType> SunburstChartTypeTemplate::getChartTypeForNewSeries2(
...
void SunburstChartTypeTemplate::GetDefaultValue(sal_Int32 nHandle, uno::Any& rAny) const
{
    static ::chart::tPropertyValueMap aStaticDefaults = []() {
        ::chart::tPropertyValueMap aTmp;
        ::chart::PropertyHelper::setPropertyValueDefault<sal_Int32>(
            aTmp, PROP_SUNBURST_TEMPLATE_DIMENSION, 2);
        ::chart::PropertyHelper::setPropertyValueDefault(aTmp, PROP_SUNBURST_TEMPLATE_GEOMETRY3D,
...
Reference<beans::XPropertySetInfo> SAL_CALL SunburstChartTypeTemplate::getPropertySetInfo()
{
    static uno::Reference<beans::XPropertySetInfo> xPropertySetInfo(
        ::cppu::OPropertySetHelper::createPropertySetInfo(
            StaticSunburstChartTypeTemplateInfoHelper()));
    return xPropertySetInfo;
}

void SunburstChartTypeTemplate::applyStyle2(const rtl::Reference<DataSeries>& xSeries,
                                            ...
                                            ::sal_Int32 nSeriesCount)
{
    ...
    try
    {
        ...
        getFastPropertyValue(aAGeometry3D, PROP_SUNBURST_TEMPLATE_GEOMETRY3D);
...
void SunburstChartTypeTemplate::resetStyles2(const rtl::Reference<::chart::Diagram>& xDiagram)
{
...
IMPLEMENT_FORWARD_XINTERFACE2(SunburstChartTypeTemplate, ChartTypeTemplate, OPropertySet)
IMPLEMENT_FORWARD_XTYPEPROVIDER2(SunburstChartTypeTemplate, ChartTypeTemplate, OPropertySet)
