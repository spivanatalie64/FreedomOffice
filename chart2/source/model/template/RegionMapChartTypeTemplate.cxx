...
enum
{
    PROP_REGIONMAP_TEMPLATE_DIMENSION,
    PROP_REGIONMAP_TEMPLATE_GEOMETRY3D
};

void lcl_AddPropertiesToVector(std::vector<Property>& rOutProperties)
{
    rOutProperties.emplace_back(
        "Dimension", PROP_REGIONMAP_TEMPLATE_DIMENSION, cppu::UnoType<sal_Int32>::get(),
        beans::PropertyAttribute::BOUND | beans::PropertyAttribute::MAYBEDEFAULT);
    rOutProperties.emplace_back(
        "Geometry3D", PROP_REGIONMAP_TEMPLATE_GEOMETRY3D, cppu::UnoType<sal_Int32>::get(),
        beans::PropertyAttribute::BOUND | beans::PropertyAttribute::MAYBEDEFAULT);
}

::cppu::OPropertyArrayHelper& StaticRegionMapChartTypeTemplateInfoHelper()
{
...
namespace chart
{
RegionMapChartTypeTemplate::RegionMapChartTypeTemplate(
...
sal_Int32 RegionMapChartTypeTemplate::getDimension() const { return m_nDim; }

// ____ ChartTypeTemplate ____
bool RegionMapChartTypeTemplate::matchesTemplate2(const rtl::Reference<::chart::Diagram>& xDiagram,
                                                  bool bAdaptProperties)
{
    ...
    if (bAdaptProperties && bResult && getDimension() == 3)
    {
        ...
        if (!bGeomAmbiguous)
        {
            setFastPropertyValue_NoBroadcast(PROP_REGIONMAP_TEMPLATE_GEOMETRY3D,
                                             uno::Any(aCommonGeom));
        }
    }
...
rtl::Reference<ChartType>
    RegionMapChartTypeTemplate::getChartTypeForIndex(sal_Int32 /*nChartTypeIndex*/)
{
    return new RegionMapChartType();
}

rtl::Reference<ChartType> RegionMapChartTypeTemplate::getChartTypeForNewSeries2(
...
void RegionMapChartTypeTemplate::GetDefaultValue(sal_Int32 nHandle, uno::Any& rAny) const
{
    static ::chart::tPropertyValueMap aStaticDefaults = []() {
        ::chart::tPropertyValueMap aTmp;
        ::chart::PropertyHelper::setPropertyValueDefault<sal_Int32>(
            aTmp, PROP_REGIONMAP_TEMPLATE_DIMENSION, 2);
        ::chart::PropertyHelper::setPropertyValueDefault(aTmp, PROP_REGIONMAP_TEMPLATE_GEOMETRY3D,
...
Reference<beans::XPropertySetInfo> SAL_CALL RegionMapChartTypeTemplate::getPropertySetInfo()
{
    static uno::Reference<beans::XPropertySetInfo> xPropertySetInfo(
        ::cppu::OPropertySetHelper::createPropertySetInfo(
            StaticRegionMapChartTypeTemplateInfoHelper()));
    return xPropertySetInfo;
}

void RegionMapChartTypeTemplate::applyStyle2(const rtl::Reference<DataSeries>& xSeries,
...
void RegionMapChartTypeTemplate::resetStyles2(const rtl::Reference<::chart::Diagram>& xDiagram)
{
...
IMPLEMENT_FORWARD_XINTERFACE2(RegionMapChartTypeTemplate, ChartTypeTemplate, OPropertySet)
IMPLEMENT_FORWARD_XTYPEPROVIDER2(RegionMapChartTypeTemplate, ChartTypeTemplate, OPropertySet)
