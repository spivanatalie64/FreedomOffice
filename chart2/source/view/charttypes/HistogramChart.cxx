...
css::awt::Point HistogramChart::getLabelScreenPositionAndAlignment(
                               ...
                               sal_Int32 xSlot, sal_Int32 ySlot)
{
    ...
    if (m_nDimension == 2)
    {
        ...
        // Plot the calculated bin frequencies rather than the raw input data.
        pSeries->useCalculatedYForRendering();
