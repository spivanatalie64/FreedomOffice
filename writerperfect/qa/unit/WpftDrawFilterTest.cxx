...
void WpftDrawFilterTest::test()
{
    ...
    doTest(u"org.freedomoffice.comp.Draw.PageMakerImportFilter"_ustr,
           u"/writerperfect/qa/unit/data/draw/libpagemaker/");
    doTest(u"org.freedomoffice.comp.Draw.StarOfficeDrawImportFilter"_ustr,
           u"/writerperfect/qa/unit/data/draw/libstaroffice/", aStarOfficeOptional);
    doTest(u"org.freedomoffice.comp.Draw.ZMFImportFilter"_ustr,
