...
void WpftWriterFilterTest::test()
{
    ...
    doTest(u"org.freedomoffice.comp.Writer.EBookImportFilter"_ustr,
    ...
    doTest(u"org.freedomoffice.comp.Writer.PagesImportFilter"_ustr,
           u"/writerperfect/qa/unit/data/writer/libetonyek/", aEtonyekOptional);
    doTest(u"org.freedomoffice.comp.Writer.StarOfficeWriterImportFilter"_ustr,
