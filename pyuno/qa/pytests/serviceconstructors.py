...
from org.freedomoffice.embindtest import ImplicitConstructor
from org.freedomoffice.embindtest import ExplicitConstructors
...
class ServiceConstructorsTest(unittest.TestCase):
    ...
    def test_invalid_arguments(self):
        ...
        self.assertEqual(str(cm.exception),
                         "org.freedomoffice.embindtest.ImplicitConstructor::create "
                         "requires 1 argument")

        with self.assertRaises(AttributeError) as cm:
            ExplicitConstructors.interfaceArgument()
        self.assertEqual(str(cm.exception),
                         "org.freedomoffice.embindtest.ExplicitConstructors::interfaceArgument "
        ...
        self.assertEqual(str(cm.exception),
                         "org.freedomoffice.embindtest.ExplicitConstructors::restArgument "
