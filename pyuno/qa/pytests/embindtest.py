...
import org.freedomoffice.unotest
import unittest
import uno
import unohelper
from com.sun.star.uno import RuntimeException
from org.freedomoffice.embindtest import Exception
from org.freedomoffice.embindtest import Struct
from org.freedomoffice.embindtest import StructLong
from org.freedomoffice.embindtest import StructString
from org.freedomoffice.embindtest import XTest
from org.freedomoffice.embindtest.Enum import E3
from org.freedomoffice.embindtest.Enum import E_10
from org.freedomoffice.embindtest.Enum import E_2
...
class Test(unohelper.Base, XTest):
    ...
    def getAnyInterface(self):
        return uno.Any('org.freedomoffice.embindtest.XTest', self)
    ...
    def getSequenceType(self):
        return (
            ...
            uno.getTypeByName('[]org.freedomoffice.embindtest.Enum'))
    ...
    def getSequenceAny(self):
        return (-123456, None, uno.Any('[]org.freedomoffice.embindtest.Enum', (E_2, E3, E_10)))
    ...
    def getSequenceStruct(self):
        return (
            Struct(
                ...
                uno.createUnoStruct(
                    'org.freedomoffice.embindtest.Template<'
                        'any,org.freedomoffice.embindtest.StructString>',
                    StructString('foo'), -123456, -123456, StructString('barr')),
                self),
            Struct(
            ...
            Struct(
                ...
                'Ö', 'bazzz', uno.getTypeByName('[]org.freedomoffice.embindtest.Enum'),
                uno.Any('[]org.freedomoffice.embindtest.Enum', (E_2, E3, E_10)), ('baz',), E_10,
                StructLong(123456),
                uno.createUnoStruct(
                    'org.freedomoffice.embindtest.Template<'
                        'any,org.freedomoffice.embindtest.StructString>',
                    StructString('barr'), 123456,
                    uno.Any('[]org.freedomoffice.embindtest.Enum', (E_2, E3, E_10)),
                    StructString('bazz')),
                self))
...
class EmbindTest(unittest.TestCase):
    def test(self):
        ctx = org.freedomoffice.unotest.pyuno.getComponentContext()
        test = ctx.getServiceManager().createInstanceWithContext(
            'org.freedomoffice.embindtest.Test', ctx)
        ...
        self.assertTrue(test.isAnyInterface(uno.Any('org.freedomoffice.embindtest.XTest', test)))
        ...
        self.assertTrue(
            test.isSequenceAny(
                (-123456, None, uno.Any('[]org.freedomoffice.embindtest.Enum', (E_2, E3, E_10)))))
            ...
            test.isSequenceStruct(
                (Struct(
                 ...
                 Struct(
                     ...
                     100.75, 'Ö', 'bazzz', uno.getTypeByName('[]org.freedomoffice.embindtest.Enum'),
                     uno.Any('[]org.freedomoffice.embindtest.Enum', (E_2, E3, E_10)), ('baz',), E_10,
                     StructLong(123456),
                     uno.createUnoStruct(
                         'org.freedomoffice.embindtest.Template<'
