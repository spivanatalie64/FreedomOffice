...
// [HKEY_LOCAL_MACHINE\SOFTWARE\Policies\FreedomOffice\org.openoffice.UserProfile\Data\o]
// "Value"="Example Corp."
...
//
// Another example:
// [HKEY_LOCAL_MACHINE\SOFTWARE\Policies\FreedomOffice\org.openoffice.Office.OptionsDialog\OptionsDialogGroups\ProductName/#fuse\Pages\Java/#fuse\Hide]
// "Value"="true"
// becomes the following in configuration:
// <!-- Hide Tools - Options - FreedomOffice - Advanced panel -->
...
// [HKEY_LOCAL_MACHINE\SOFTWARE\Policies\FreedomOffice\org.openoffice.Office.Jobs\Jobs\org.openoffice.Office.Jobs:Job['UpdateCheck']\Arguments\AutoCheckEnabled]
// "Value"="false"
// "Final"=dword:00000001
// "Type"="xs:boolean"
// becomes the following in configuration:
...
// [HKEY_CURRENT_USER\Software\Policies\FreedomOffice\org.openoffice.UserProfile\Data\o]
// "Value"="company"
// "Final"=dword:00000001
...
// [HKEY_CURRENT_USER\Software\Policies\FreedomOffice\org.openoffice.Office.Common\Path\Current\Work]
// "Value"=""
// "Final"=dword:00000001
// "Nil"=dword:00000001
// [HKEY_CURRENT_USER\Software\Policies\FreedomOffice\org.openoffice.Office.Paths\Paths\org.openoffice.Office.Paths:NamedPath['Work']\WritePath]
// "Value"="file:///H:/"
// "Final"=dword:00000001
// becomes the following in configuration:
...
bool dumpWindowsRegistry(OUString* pFileURL, WinRegType eType)
{
    ...
    if(RegOpenKeyExW(hDomain, L"SOFTWARE\\Policies\\FreedomOffice", 0, KEY_READ, &hKey) != ERROR_SUCCESS)
    {
        SAL_INFO(
            "configmgr",
            "Windows registry settings do not exist in " << winRegTypeName(eType)
            << " HKLM\\SOFTWARE\\Policies\\FreedomOffice");
        return false;
    }
