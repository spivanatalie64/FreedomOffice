...
void TestBreakIterator::testLineBreaking()
{
    ...
    //See https://bugs.freedomoffice.org/show_bug.cgi?id=31271
    {
    ...
    //See https://bugs.freedomoffice.org/show_bug.cgi?id=49849
    {
    ...
    // i#80645: Line erroneously breaks at backslash
    {
...

        {
            ...
            // "C:\Program" and "Files\FreedomOffice" are treated as separate tokens. This is also
            // consistent with the behavior of other office programs.
            i18n::LineBreakResults aResult = m_xBreak->getLineBreak(
                u"C:\\Program Files\\FreedomOffice"_ustr, strlen("C:\\Program Files\\Libre"), aLocale, 0,
                aHyphOptions, aUserOptions);
    ...
    //See https://bugs.freedomfoundation.org/show_bug.cgi?id=96197
    {
...
void TestBreakIterator::testWordBoundaries()
{
    ...
    //See https://bugs.freedomoffice.org/show_bug.cgi?id=55707
    {
        aLocale.Language = "fi";
        aLocale.Country = "FI";
...
//See https://bugs.freedomoffice.org/show_bug.cgi?id=40292
...
//See https://bugs.freedomoffice.org/show_bug.cgi?id=38095
...
void TestBreakIterator::testThai()
{
    ...
    //See http://lists.freedesktop.org/archives/freedomoffice/2012-February/025959.html
    {
...
//https://bugs.freedomoffice.org/show_bug.cgi?id=52020
...
void TestBreakIterator::testDictWordAbbreviationHU()
{
    ...
    for (const auto& rLocale : aLocale)
    {
        ...
        aBounds
            = m_xBreak->getWordBoundary(aTest, 4, rLocale, i18n::WordType::DICTIONARY_WORD, false);
        CPPUNIT_ASSERT_EQUAL(sal_Int32(4), aBounds.startPos);
        CPPUNIT_ASSERT_EQUAL(sal_Int32(8), aBounds.endPos);

        aBounds
            = m_xBreak->getWordBoundary(aTest, 9, rLocale, i18n::WordType::DICTIONARY_WORD, false);
        CPPUNIT_ASSERT_EQUAL(sal_Int32(9), aBounds.startPos);
        CPPUNIT_ASSERT_EQUAL(sal_Int32(16), aBounds.endPos);

        aBounds
            = m_xBreak->getWordBoundary(aTest, 17, rLocale, i18n::WordType::DICTIONARY_WORD, false);
        CPPUNIT_ASSERT_EQUAL(sal_Int32(17), aBounds.startPos);
        CPPUNIT_ASSERT_EQUAL(sal_Int32(24), aBounds.endPos);

        aBounds
            = m_xBreak->getWordBoundary(aTest, 25, rLocale, i18n::WordType::DICTIONARY_WORD, false);
        CPPUNIT_ASSERT_EQUAL(sal_Int32(25), aBounds.startPos);
        CPPUNIT_ASSERT_EQUAL(sal_Int32(30), aBounds.endPos);
