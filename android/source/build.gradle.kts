...
base {
    archivesName.set("FreedomOfficeViewer")
}

android {
    namespace = "org.freedomoffice"
    compileSdk = 36
...
tasks.register("createStrippedConfig") {
    val preserveDir = file("assets_strippedUI/share/config/FREEDOMOFFICE.cfg/empty")
    ...
    doLast {
        ...
        file("assets_strippedUI/share/config/FREEDOMOFFICE.cfg").mkdirs()
        // just empty file
...
tasks.register("createRCfiles") {
    ...
    doLast {
        ...
        bootstraprc.writeText("""
            ...
            ProductKey=FreedomOffice ${liboVersionMajor}.${liboVersionMinor}
