...
import org.freedomoffice.AboutDialogFragment;
import org.freedomoffice.BuildConfig;
import org.freedomoffice.FreedomOfficeMainActivity;
import org.freedomoffice.R;
import org.freedomoffice.SettingsActivity;
...
public class FreedomOfficeUIActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private static final String LOGTAG = FreedomOfficeUIActivity.class.getSimpleName();
    ...
    public void createUI() {
        ...
        final boolean bEditingEnabled = BuildConfig.ALLOW_EDITING && preferences.getBoolean(FreedomOfficeMainActivity.ENABLE_EXPERIMENTAL_PREFS_KEY, false);
    ...
    public void openDocument(final Uri documentUri) {
        // "forward" to FreedomOfficeMainActivity to open the file
        ...
        ComponentName componentName = new ComponentName(packageName,
            FreedomOfficeMainActivity.class.getName());
    ...
    private void loadNewDocument(DocumentType docType) {
        ...
        Intent intent = new Intent(FreedomOfficeUIActivity.this, FreedomOfficeMainActivity.class);
    ...
    private void addDocumentToRecents(Uri fileUri) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N_MR1) {
            ...
            for (String recentDoc : recentsList) {
                ...
                ComponentName componentName = new ComponentName(packageName, FreedomOfficeMainActivity.class.getName());
                intent.setComponent(componentName);
