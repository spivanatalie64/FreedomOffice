...
public class LOKitShell {
    public static float getDpi(Context context) {
        LOKitTileProvider tileProvider = ((FreedomOfficeMainActivity)context).getTileProvider();
    ...
    public static Handler getMainHandler() {
        return FreedomOfficeApplication.getMainHandler();
    }

    public static void showProgressSpinner(final FreedomOfficeMainActivity context) {
    ...
    public static void hideProgressSpinner(final FreedomOfficeMainActivity context) {
        getMainHandler().post(new Runnable() {
            @Override
            public void run() {
    ...
    public static boolean isEditingEnabled() {
        return !FreedomOfficeMainActivity.isReadOnlyMode();
    }
    ...
    public static void sendEvent(LOEvent event) {
        FreedomOfficeMainActivity.loKitThread.queueEvent(event);
    }
    ...
    public static void sendSizeChangedEvent() {
     ...
     */
    public static void moveViewportTo(final FreedomOfficeMainActivity context, final PointF position, final Float zoom) {
