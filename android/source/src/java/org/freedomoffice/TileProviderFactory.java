...
public class TileProviderFactory {
    ...
    public static void initialize() {
        FreedomOfficeKit.initializeLibrary();
    }

    public static TileProvider create(FreedomOfficeMainActivity context, InvalidationHandler invalidationHandler, String filename) {
