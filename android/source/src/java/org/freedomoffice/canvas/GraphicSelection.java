...
import static org.freedomoffice.canvas.GraphicSelectionHandle.HandlePosition;
...
public class GraphicSelection extends CommonCanvasElement {
     ...
     */
    public GraphicSelection(FreedomOfficeMainActivity context) {
        mContext = context;
     ...
     * @see org.freedomoffice.canvas.CanvasElement#draw(android.graphics.Canvas)
     */
    @Override
