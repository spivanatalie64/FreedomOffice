...
public class ToolbarController implements Toolbar.OnMenuItemClickListener {
    ...
    public ToolbarController(FreedomOfficeMainActivity context, Toolbar toolbarTop) {
    ...
    void switchToEditMode() {
        ...
        LOKitShell.getMainHandler().post(new Runnable() {
            ...
            public void run() {
                ...
                if (!FreedomOfficeMainActivity.isDeveloperMode() && mMainMenu.findItem(R.id.action_UNO_commands) != null) {
    ...
    void setupToolbars() {
        if (FreedomOfficeMainActivity.isExperimentalMode()) {
            boolean enableSaveEntry = !FreedomOfficeMainActivity.isReadOnlyMode() && mContext.hasLocationForSave();
            setItemVisible(R.id.action_save, enableSaveEntry);
            if (FreedomOfficeMainActivity.isReadOnlyMode()) {
