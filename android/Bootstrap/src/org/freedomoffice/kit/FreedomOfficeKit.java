...
// seems.
public final class FreedomOfficeKit
{
    private static String LOGTAG = FreedomOfficeKit.class.getSimpleName();
    private static AssetManager mgr;

    // private constructor because instantiating would be meaningless
    private FreedomOfficeKit() {
    }
    ...
    public static native ByteBuffer getFreedomOfficeKitHandle();
    ...
    public static synchronized void init(Activity activity)
    {
        ...
        Log.i(LOGTAG, String.format("Initializing FreedomOfficeKit, dataDir=%s\n", dataDir));
