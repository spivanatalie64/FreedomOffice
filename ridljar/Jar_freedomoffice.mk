...
$(eval $(call gb_Jar_Jar,freedomoffice,org.freedomoffice.uno))

$(eval $(call gb_Jar_use_customtargets,freedomoffice,\
    ridljar/javamaker \
    unoil/javamaker \
))

$(eval $(call gb_Jar_use_jars,freedomoffice, \
    unoloader \
))

$(eval $(call gb_Jar_use_externals,freedomoffice,\
    java_websocket \
))

$(eval $(call gb_Jar_set_packageroot,freedomoffice,com))

$(eval $(call gb_Jar_set_manifest,freedomoffice,$(SRCDIR)/ridljar/util/manifest))

$(eval $(call gb_Jar_add_manifest_classpath,freedomoffice, \
    java_websocket.jar \
    unoloader.jar \
...
$(eval $(call gb_Jar_add_packagedirs,freedomoffice,\
    $(gb_CustomTarget_workdir)/ridljar/javamaker/com \
    $(gb_CustomTarget_workdir)/unoil/javamaker/com \
	$(if $(MODULAR_JAVA),$(call gb_JavaClassSet_get_classdir,$(call gb_Jar_get_classsetname,freedomoffice))/module-info.class) \
))

$(if $(MODULAR_JAVA),$(eval $(call gb_Jar_add_sourcefiles_java9,freedomoffice,\
    ridljar/source/freedomoffice/module-info \
)))

$(eval $(call gb_Jar_add_sourcefiles,freedomoffice,\
