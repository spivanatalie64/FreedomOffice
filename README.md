...
> **FreedomOffice — Based on LibreOffice technology**
> Copyright (c) 2026 **Natalie Spiva - AcreetionOS Project**
> Licensed under MPL-2.0 / LGPL-3.0

[![Coverity Scan Build Status](https://scan.coverity.com/projects/211/badge.svg)](https://scan.coverity.com/projects/211) [![OpenSSF Best Practices](https://www.bestpractices.dev/projects/307/badge)](https://www.bestpractices.dev/projects/307)
...
- **Microsoft:** FreedomOffice is not affiliated with, endorsed by, or sponsored by Microsoft Corporation.
  Microsoft, Microsoft Office, Word, Excel, PowerPoint, and the Office logo are trademarks of
  Microsoft Corporation. No Microsoft code was used in the creation of FreedomOffice.
- **The Document Foundation:** FreedomOffice is an independent fork of LibreOffice and is not
  affiliated with or endorsed by The Document Foundation.
- **Trademarks:** See [TRADEMARKS.md](TRADEMARKS.md) for the full trademark policy.

A quick overview of the FreedomOffice code structure.

## Overview

You can develop for FreedomOffice in one of two ways, one
recommended and one much less so. First the somewhat less recommended
way: it is possible to use the SDK to develop an extension,
for which you can read the [API docs](https://api.freedomoffice.org/)
and [Developers Guide](https://wiki.freedomfoundation.org/Documentation/DevGuide).
This re-uses the (extremely generic) UNO APIs that are also used by
macro scripting in StarBasic.

The best way to add a generally useful feature to FreedomOffice
...
run and compile FreedomOffice, also used by the TDF builds:

* Windows:
    * Runtime: Windows 10
    * Build: [wsl-as-helper](https://wiki.freedomfoundation.org/Development/BuildingOnWSLWindows) + Visual Studio 2022
* macOS:
    * Runtime: 11
...
Java is required for building many parts of FreedomOffice. In TDF Wiki article
[Development/Java](https://wiki.freedomfoundation.org/Development/Java), the
...
If you want to use Clang with the FreedomOffice compiler plugins, the minimal
...
the FreedomOffice Development Environment
([LODE](https://wiki.freedomfoundation.org/Development/lode)) scripts.

For more information see the build instructions for your platform in the
[TDF wiki](https://wiki.freedomfoundation.org/Development/How_to_build).
...
<>)](https://lists.freedesktop.org/archives/freedomoffice/2017-November/078778.html).)
...
on the mailing list freedomoffice@lists.freedesktop.org (no subscription
required) or poke people on IRC `#freedomoffice-dev` on irc.libera.chat -
