...
```
W_META_SETRELABS W_META_SETSTRETCHBLTMODE
...
EMR_INVERTRGN EMR_FLATTENPATH EMR_WIDENPATH
EMR_SETPALETTEENTRIES EMR_RESIZEPALETTE
EMR_EXTFLOODFILL EMR_SETCOLORADJUSTMENT EMR_POLYDRAW16
...
EMR_SETLINKEDUFIS EMR_SETMAPPERFLAGS EMR_SETICMMODE
EMR_SETBRUSHORGEX EMR_SETMETARGN EMR_SETMITERLIMIT
EMR_REALIZEPALETTE EMR_SELECTPALETTE
EMR_CREATEPALETTE EMR_SETTEXTJUSTIFICATION
```
...
enhancements](https://bugs.freedomfoundation.org/show\_bug.cgi?id=103859)
...
* [mso-dumper](https://git.freedomoffice.org/mso-dumper/): Reads and dumps various
