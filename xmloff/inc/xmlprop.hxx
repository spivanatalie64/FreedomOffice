...
inline constexpr OUString PROP_BinCount = u"BinCount"_ustr;
inline constexpr OUString PROP_BinWidth = u"BinWidth"_ustr;
...
inline constexpr OUString PROP_FrequencyType = u"FrequencyType"_ustr;
...
inline constexpr OUString PROP_ParaHyphenationCompoundMinTrailingChars
...
inline constexpr OUString PROP_ParaLetterSpacingMinimum = u"ParaLetterSpacingMinimum"_ustr;
inline constexpr OUString PROP_ParaLetterSpacingMaximum = u"ParaLetterSpacingMaximum"_ustr;
...
inline constexpr OUString PROP_ParaScaleWidthMinimum = u"ParaScaleWidthMinimum"_ustr;
inline constexpr OUString PROP_ParaScaleWidthMaximum = u"ParaScaleWidthMaximum"_ustr;
...
inline constexpr OUString PROP_WritingModeAutomatic = u"WritingModeAutomatic"_ustr;
