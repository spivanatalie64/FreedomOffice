...
class tdf148437(UITestCase):
    def test_tdf148437_formula_cell(self):
        with self.ui_test.create_doc_in_start_center("calc") as document:
            ...
            enter_text_to_cell(xGridWindow, "A1", "=HYPERLINK(\"www.freedomoffice.org\";\"FreedomOffice\")")
            ...
            with self.ui_test.execute_dialog_through_command(".uno:HyperlinkDialog") as xDialog:
                ...
                xIndication.executeAction("TYPE", mkPropertyValues({"TEXT": "FreedomOffice Document Foundation"}))
