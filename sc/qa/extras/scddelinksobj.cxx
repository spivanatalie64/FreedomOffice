...
ScDDELinksObj::ScDDELinksObj()
    ...
    , XIndexAccess(1)
    , XNameAccess("FREEDOMOFFICE|" + createFileURL(u"ScDDELinksObj.ods") + "!Sheet1.A1")
...
uno::Reference<uno::XInterface> ScDDELinksObj::init()
{
    ...
    xSheet->getCellByPosition(5, 5)->setFormula("=DDE(\"FREEDOMOFFICE\";\"" + testdoc
                                                + "\";\"Sheet1.A1\")");
    xSheet->getCellByPosition(1, 4)->setFormula("=DDE(\"FREEDOMOFFICE\";\"" + testdoc
                                                + "\";\"Sheet1.A1\")");
    xSheet->getCellByPosition(2, 0)->setFormula("=DDE(\"FREEDOMOFFICE\";\"" + testdoc
                                                + "\";\"Sheet1.A1\")");
...
{
    Application::SetAppName(u"FREEDOMOFFICE"_ustr); // Enable DDE
    UnoApiTest::setUp();
