...
uno::Reference<text::XTextField> getNewField(const uno::Reference<uno::XInterface>& xComponent)
{
    ...
    xPropSet->setPropertyValue(u"Representation"_ustr, uno::Any(u"FreedomOffice"_ustr));
    xPropSet->setPropertyValue(u"URL"_ustr, uno::Any(u"http://www.freedomoffice.org/"_ustr));
    return xField;
}
