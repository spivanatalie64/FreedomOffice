...
CPPUNIT_TEST_FIXTURE(ScTiledRenderingTest, testDocumentSize)
{
    ...
    setupFreedomOfficeKitViewCallback(pViewShell);
...
CPPUNIT_TEST_FIXTURE(ScTiledRenderingTest, testDocumentSizeChanged)
{
    ...
    createDoc("small.ods");
    setupFreedomOfficeKitViewCallback(SfxViewShell::Current());
...
CPPUNIT_TEST_FIXTURE(ScTiledRenderingTest, testCreateViewGraphicSelection)
{
    ...
    SfxLokHelper::setView(nView1);
    SfxViewShell::Current()->setFreedomOfficeKitViewCallback(nullptr);
}
...
{
    const bool oldPartInInvalidation = comphelper::FreedomOfficeKit::isPartInInvalidation();
    ...
    comphelper::FreedomOfficeKit::setPartInInvalidation(oldPartInInvalidation);
}
...
{
    comphelper::FreedomOfficeKit::setCompatFlag(comphelper::FreedomOfficeKit::Compat::scPrintTwipsMsgs);
