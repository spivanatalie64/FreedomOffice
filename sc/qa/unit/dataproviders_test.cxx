...
void ScDataProvidersTest::testCSVImport()
{
    ...
    sc::ExternalDataSource aDataSource(aFileURL, u"org.freedomoffice.calc.csv"_ustr, pDoc);
...
void ScDataProvidersTest::testHTMLImport()
{
    ...
    sc::ExternalDataSource aDataSource(aFileURL, u"org.freedomoffice.calc.html"_ustr, pDoc);
...
void ScDataProvidersTest::testXMLImport()
{
    ...
    sc::ExternalDataSource aDataSource(aFileURL, u"org.freedomoffice.calc.xml"_ustr, pDoc);
...
void ScDataProvidersTest::testBaseImport()
{
    ...
    sc::ExternalDataSource aDataSource("~/dummy.file", "org.freedomoffice.calc.sql", pDoc);
