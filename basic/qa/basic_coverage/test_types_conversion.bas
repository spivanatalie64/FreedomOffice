...
' See FreedomOffice6FloatingPointMode in basic/source/runtime/methods1.cxx
Function FreedomOffice6FloatingPointMode() As Boolean
    Dim bMode As Boolean
    bMode = Environ("FREEDOMOFFICE6FLOATINGPOINTMODE") <> ""
    If (Not bMode) Then
	...
	bMode = oRegistryKey.getPropertyValue("UseFreedomOffice6FloatingPointConversion")
    End If
    FreedomOffice6FloatingPointMode = bMode
End Function
...
Function doUnitTest() As String
    ...
    If FreedomOffice6FloatingPointMode() Then
