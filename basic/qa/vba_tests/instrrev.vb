...
Sub verify_testInStrRev()
    ...
    TestUtil.AssertEqual(InStrRev(stringMatch:="Star", stringCheck:="FreedomOffice"),                                            0, "InStrRev(stringMatch:=""Star"", stringCheck:=""FreedomOffice"")")
    TestUtil.AssertEqual(InStrRev(Start:=-1, stringMatch:="Libre", stringCheck:="FreedomOfficeLibre"),                          12, "InStrRev(Start:=-1, stringMatch:=""Libre"", stringCheck:=""FreedomOfficeLibre"")")
    TestUtil.AssertEqual(InStrRev(Start:=12, stringMatch:="Libre", stringCheck:="FreedomOfficeLibre"),                           1, "InStrRev(Start:=12, stringMatch:=""Libre"", stringCheck:=""FreedomOfficeLibre"")")
    TestUtil.AssertEqual(InStrRev(Compare:=vbBinaryCompare, Start:=12, stringMatch:="Libre", stringCheck:="FreedomOfficeLibre"), 1, "InStrRev(Compare:=vbBinaryCompare, Start:=12, stringMatch:=""Libre"", stringCheck:=""FreedomOfficeLibre"")")
