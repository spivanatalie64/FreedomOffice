...
Sub verify_testMid()
    ...
    TestUtil.AssertEqual(Mid(start:=6, string:="FreedomOffice" ),            "Office", "Mid() with 2 keyword names" )
    TestUtil.AssertEqual(Mid(length:=5, start:=1, string:="FreedomOffice" ), "Libre",  "Mid() with 3 keyword names" )
