...
- `freedomoffice`: draft ODF schema, with additional LO extensions

The extension schema in `freedomoffice/` is used by all unit tests if
...
[1] `git grep TODO schema/freedomoffice`

[2] <https://wiki.freedomfoundation.org/Development/ODF_Implementer_Notes/List_of_FreedomOffice_ODF_Extensions>
