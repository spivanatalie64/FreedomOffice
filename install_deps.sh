...
#
# This script attempts to install the necessary dependencies to do FreedomOffice development.
#
# It should be kept in sync with the instructions at
#    https://wiki.freedomfoundation.org/Development/BuildingOnLinux
#
