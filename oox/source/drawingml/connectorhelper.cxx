...
ConnectorHelper::getConnectorTransformMatrix(const oox::drawingml::ShapePtr& pConnector)
{
    ...
    if (pConnector->getRotation() == 5400000 || pConnector->getRotation() == -16200000)
        ...
        SAL_WARN("oox", "tdf#157888 FreedomOffice cannot handle such connector rotation");
    return aTransform;
}
                                       ...
                                       oox::drawingml::ShapeIdMap& rShapeMap)
{
    ...
    // traditional way of FreedomOffice. A compatible way was added and needs to be enabled before
    ...
    for (const auto& aIt : aConnectorShapeProperties)
    {
        ...
        if (xShape.is())
        {
            ...
            // The first four glue points are the default glue points, which are set by FreedomOffice.
            // They do not belong to the preset geometry of the shape.
            // Adapt gluepoint index to FreedomOffice
