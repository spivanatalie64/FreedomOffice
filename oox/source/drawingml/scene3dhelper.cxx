...
struct PrstCameraValues
{
    ...
    // FreedomOffice can handle values outside the ODF range.
    ...
    const bool bIsParallel, const sal_Int32 rnMSOShapeRotation)
{
    ...
    else
    {
        ...
        // distance in FreedomOffice. MS Office users can change its value.
                                          ...
                                          const double& rfRotZ, oox::PropertyMap& rPropertyMap)
{
    ...
    // MS Office. For legacy cameras MS Office behaves same as FreedomOffice: Not the camera is moved
