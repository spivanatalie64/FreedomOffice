...
SAL_LOG='+INFO.oox.csdata-WARN' instdir/program/FREEDOMOFFICE --headless --convert-to odp --outdir oox/source/drawingml/customshapes/ oox/source/drawingml/customshapes/pptx/cshape-all.pptx > oox/source/drawingml/customshapes/custom-shapes.log 2>&1
