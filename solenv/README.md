...
critical for building FreedomOffice:
...
- `gbuild/`
    ...
    implementation of the FreedomOffice build system
...
- `flatpak-external-tarballs.json.in`
    ...
    This file is processed by solenv/bin/generate-flatpak-manifest.sh and the result copied manually to https://github.com/flathub/org.freedomoffice.FreedomOffice/blob/master/external-tarballs.json
