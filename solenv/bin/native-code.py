...
# chart2/source/chart2.component
    ...
    "org_freedomoffice_chart2_Chart2ToolboxController",
    "org_freedomoffice_comp_chart2_sidebar_ChartPanelFactory",
...
if options.java:
    print ("""
    extern void Java_org_freedomoffice_kit_FreedomOfficeKit_initializeNative();
    volatile void *p = (void *) Java_org_freedomoffice_kit_FreedomOfficeKit_initializeNative;

    extern void Java_org_freedomoffice_kit_Office_getError();
    p = (void *) Java_org_freedomoffice_kit_Office_getError;
