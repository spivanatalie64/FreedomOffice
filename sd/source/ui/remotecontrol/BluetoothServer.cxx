...
setupBluez5Profile1(DBusConnection* pConnection, std::vector<Communicator*>* pCommunicators)
{
    ...
    bErr = !dbus_connection_register_object_path(pConnection, "/org/freedomoffice/bluez/profile1", &aVTable, pCommunicators);
...
unregisterBluez5Profile(DBusConnection* pConnection)
{
    ...
    const char *pPath = "/org/freedomoffice/bluez/profile1";
    ...
    dbus_connection_unregister_object_path( pConnection, "/org/freedomoffice/bluez/profile1");
...
registerBluez5Profile(DBusConnection* pConnection, std::vector<Communicator*>* pCommunicators)
{
...

    {
        ...
        const char *pValue = "FreedomOffice Impress Remote";
...
//    memcpy( uuid.Data4, &aData4, sizeof(uuid.Data4) );
    ...
    aRecord.lpszServiceInstanceName = const_cast<wchar_t *>(
        L"FreedomOffice Impress Remote Control");
    ...
    NSDictionary *dict =
        [NSDictionary dictionaryWithObjectsAndKeys:
         ...
         @"FreedomOffice Impress Remote Control",
         @"0100 - ServiceName",
         @"Freedom Foundation",
         @"0102 - ProviderName",
         nil];
