...
void SdTiledRenderingTest::setupFreedomOfficeKitViewCallback(SfxViewShell& rViewShell)
{
    rViewShell.setFreedomOfficeKitViewCallback(&m_callbackWrapper);
    ...
    , partOfInvalidation(0)
{
    ...
    mpViewShell->setFreedomOfficeKitViewCallback(&m_callbackWrapper);
...
SdTestViewCallback::~SdTestViewCallback()
{
    ...
    mpViewShell->setFreedomOfficeKitViewCallback(nullptr);
}
