...
from freedomoffice.uno.propertyvalue import convert_property_values_to_dict, mkPropertyValues
...
def get_url_for_data_file(file_name):
    return pathlib.Path(org.freedomoffice.unotest.makeCopyFromTDOC(file_name)).as_uri()
