...
ifeq (TRUE,$(LIBO_TEST_INSTALL))
	unzip -q -d $(TESTINSTALLDIR) $(instsetoo_OUT)/$(PRODUCTNAME_WITHOUT_SPACES)/archive/install/en-US/FreedomOffice*_archive.zip
	mv $(TESTINSTALLDIR)/FreedomOffice*_archive/FreedomOffice*/* $(TESTINSTALLDIR)/
	rmdir $(TESTINSTALLDIR)/FreedomOffice*_archive/FreedomOffice*
	rmdir $(TESTINSTALLDIR)/FreedomOffice*_archive
ifeq (ODK,$(filter ODK,$(BUILD_TYPE)))
	unzip -q -d $(TESTINSTALLDIR) $(instsetoo_OUT)/$(PRODUCTNAME_WITHOUT_SPACES)_SDK/archive/install/en-US/FreedomOffice*_archive_sdk.zip
	mv $(TESTINSTALLDIR)/FreedomOffice*_archive_sdk/FreedomOffice*_SDK/sdk \
        $(TESTINSTALLDIR)/
	rmdir $(TESTINSTALLDIR)/FreedomOffice*_archive_sdk/FreedomOffice*_SDK
	rmdir $(TESTINSTALLDIR)/FreedomOffice*_archive_sdk
endif
