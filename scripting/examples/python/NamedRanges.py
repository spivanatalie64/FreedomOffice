...
def DefineNamedRange(doc, SheetName, rangeName, rangeReference):
    ...
    API Reference:
    https://api.freedomoffice.org/docs/idl/ref/interfacecom_1_1sun_1_1star_1_1sheet_1_1XNamedRanges.html
    """
    aName = rangeName
...
def NamedRanges():
    ...
    # 2 = CENTER, see enum CellHoriJustify in https://api.freedomoffice.org/docs/idl/ref/namespacecom_1_1sun_1_1star_1_1table.html
