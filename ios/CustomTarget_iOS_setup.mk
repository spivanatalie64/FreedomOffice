...
$(IOSGEN)/native-code.h: $(BUILDDIR)/config_host.mk \
	...
	cp -R $(INSTDIR)/share/config/FREEDOMOFFICE.cfg $(IOSRES)/share/config
	...
	&& echo "ProductKey=FreedomOffice $(PRODUCTVERSION)" \
