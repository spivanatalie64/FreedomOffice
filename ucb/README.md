...
to strings in content broker world, or connect FreedomOffice with
...
https://wiki.freedomfoundation.org/Documentation/DevGuide/Universal_Content_Providers#The_WebDAV_Content_Provider
...
implementation (since FreedomOffice 7.3), but in case of behavioural
...
* The upper layer implements the UNO API which is called by FreedomOffice, and
