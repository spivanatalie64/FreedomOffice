...
namespace cmis
{
inline constexpr OUString CMIS_REPO_TYPE = u"application/vnd.freedomoffice.cmis-repository"_ustr;
inline constexpr OUString CMIS_FILE_TYPE = u"application/vnd.freedomoffice.cmis-file"_ustr;
inline constexpr OUString CMIS_FOLDER_TYPE = u"application/vnd.freedomoffice.cmis-folder"_ustr;
