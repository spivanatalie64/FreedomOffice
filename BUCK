...
# toolchain to upload FreedomOffice API to Maven Central
prebuilt_jar(
  name = 'juh',
...
prebuilt_jar(
  name = 'freedomoffice',
  binary_jar = 'instdir/program/classes/freedomoffice.jar',
  visibility = ['PUBLIC'],
)
...
zip_file(
  ...
  srcs = [
   ...
   ':freedomoffice',
   '//ridljar:freedomoffice-src',
   '//ridljar:freedomoffice-javadoc',
  ]
)
