...
console.assert(
    uno.type.sequence(uno.type.enum(uno.idl.org.freedomoffice.embindtest.Enum)).toString()
    == '[]org.freedomoffice.embindtest.Enum');
console.assert(
    uno.type.enum(uno.idl.org.freedomoffice.embindtest.Enum).toString() == 'org.freedomoffice.embindtest.Enum');
console.assert(
    uno.type.struct(uno.idl.org.freedomoffice.embindtest.Struct).toString()
    == 'org.freedomoffice.embindtest.Struct');
console.assert(
    uno.type.struct(
        uno.idl.org.freedomoffice.embindtest.Template,
        [uno.type.any, uno.type.struct(uno.idl.org.freedomoffice.embindtest.StructString)]).toString()
    == 'org.freedomoffice.embindtest.Template<any,org.freedomoffice.embindtest.StructString>');
console.assert(
    uno.type.exception(uno.idl.org.freedomoffice.embindtest.Exception).toString()
    == 'org.freedomoffice.embindtest.Exception');
console.assert(
    uno.type.interface(uno.idl.org.freedomoffice.embindtest.XTest).toString()
    == 'org.freedomoffice.embindtest.XTest');
console.assert(uno.idl.org.freedomoffice.embindtest.Constants.Boolean === true);
console.assert(uno.idl.org.freedomoffice.embindtest.Constants.Byte === -12);
console.assert(uno.idl.org.freedomoffice.embindtest.Constants.Short === -1234);
console.assert(uno.idl.org.freedomoffice.embindtest.Constants.UnsignedShort === 54321);
console.assert(uno.idl.org.freedomoffice.embindtest.Constants.Long === -123456);
console.assert(uno.idl.org.freedomoffice.embindtest.Constants.UnsignedLong === 3456789012);
console.assert(uno.idl.org.freedomoffice.embindtest.Constants.Hyper === -123456789n);
console.assert(uno.idl.org.freedomoffice.embindtest.Constants.UnsignedHyper === 9876543210n);
console.assert(uno.idl.org.freedomoffice.embindtest.Constants.Float === -10.25);
console.assert(uno.idl.org.freedomoffice.embindtest.Constants.Double === 100.5);
const test = uno.idl.org.freedomoffice.embindtest.Test.create(uno.componentContext);
{
...
}
{
    ...
    console.log(v);
    console.assert(v === uno.idl.org.freedomoffice.embindtest.Enum.E_2);
    console.assert(test.isEnum(uno.idl.org.freedomoffice.embindtest.Enum.E_2));
}
{
    ...
    console.assert(v.m16 === uno.idl.org.freedomoffice.embindtest.Enum.E_2);
    ...
    console.assert(test.isStruct(
        new uno.idl.org.freedomoffice.embindtest.Struct({
            ...
            m16: uno.idl.org.freedomoffice.embindtest.Enum.E_2,
            m17: new uno.idl.org.freedomoffice.embindtest.StructLong({m: -123456}),
            m18: new uno.idl.org.freedomoffice.embindtest.Template(
                [uno.type.any,
                 uno.type.struct(
                     uno.idl.org.freedomoffice.embindtest.StructString)],
                {m1: new uno.idl.org.freedomoffice.embindtest.StructString({m: 'foo'}),
                 m2: -123456, m3: -123456,
                 m4: new uno.idl.org.freedomoffice.embindtest.StructString({m: 'barr'})}),
            m19: test})));
    console.assert(test.isStruct({
        m1: true, m2: -12, m3: -1234, m4: 54321, m5: -123456, m6: 3456789012,
        m7: -123456789n, m8: 9876543210n, m9: -10.25, m10: 100.5, m11: 'Ö', m12: 'hä',
        m13: uno.type.long, m14: -123456, m15: ['foo', 'barr', 'bazzz'],
        m16: uno.idl.org.freedomoffice.embindtest.Enum.E_2, m17: {m: -123456},
        m18: {m1: {m: 'foo'}, m2: -123456, m3: -123456, m4: {m: 'barr'}}, m19: test}));
    const def = new uno.idl.org.freedomoffice.embindtest.Struct();
    ...
    console.assert(def.m16 === uno.idl.org.freedomoffice.embindtest.Enum.E_10);
...

{
    ...
    console.assert(test.isTemplate(
        new uno.idl.org.freedomoffice.embindtest.Template(
            [uno.type.any, uno.type.struct(uno.idl.org.freedomoffice.embindtest.StructString)],
            {m1: new uno.idl.org.freedomoffice.embindtest.StructString({m: 'foo'}),
             m2: -123456, m3: -123456,
             m4: new uno.idl.org.freedomoffice.embindtest.StructString({m: 'barr'})})));
    console.assert(test.isTemplate(
        {m1: {m: 'foo'}, m2: -123456, m3: -123456, m4: {m: 'barr'}}));
    const def = new uno.idl.org.freedomoffice.embindtest.Template(
        [uno.type.any, uno.type.struct(uno.idl.org.freedomoffice.embindtest.StructString)]);
...
}
{
    ...
    console.log(v);
    console.assert(v === uno.idl.org.freedomoffice.embindtest.Enum.E_2);
    console.assert(test.isAnyEnum(uno.idl.org.freedomoffice.embindtest.Enum.E_2));
    console.assert(test.isAnyEnum(
        new uno.Any(
            uno.type.enum(uno.idl.org.freedomoffice.embindtest.Enum),
            uno.idl.org.freedomoffice.embindtest.Enum.E_2)));
}
{
    ...
    console.assert(test.isAnyStruct(
        new uno.Any(
            uno.type.struct(uno.idl.org.freedomoffice.embindtest.Struct),
...

{
    ...
    console.assert(test.isAnyException(
        new uno.idl.org.freedomoffice.embindtest.Exception(
            {Message: 'error', m1: -123456, m2: 100.5, m3: 'hä'})));
    console.assert(test.isAnyException(
        new uno.Any(
            uno.type.exception(uno.idl.org.freedomoffice.embindtest.Exception),
...
}
{
    ...
    console.assert(test.isAnyInterface(
        new uno.Any(uno.type.interface(uno.idl.org.freedomoffice.embindtest.XTest), test)));
}
{
...
}
{
    ...
    console.assert(v[2].toString() === '[]org.freedomoffice.embindtest.Enum');
    console.assert(test.isSequenceType([
        uno.type.long, uno.type.void,
        uno.type.sequence(uno.type.enum(uno.idl.org.freedomoffice.embindtest.Enum))]));
}
{
    ...
    console.assert(v[2][0] === uno.idl.org.freedomoffice.embindtest.Enum.E_2);
    console.assert(v[2][1] === uno.idl.org.freedomoffice.embindtest.Enum.E3);
    console.assert(v[2][2] === uno.idl.org.freedomoffice.embindtest.Enum.E_10);
    console.assert(test.isSequenceAny([
        -123456, undefined,
        new uno.Any(
            uno.type.sequence(uno.type.enum(uno.idl.org.freedomoffice.embindtest.Enum)),
            [uno.idl.org.freedomoffice.embindtest.Enum.E_2,
             uno.idl.org.freedomoffice.embindtest.Enum.E3,
             uno.idl.org.freedomoffice.embindtest.Enum.E_10])]));
}
{
...
}
{
    ...
    console.log(v);
    console.assert(v.length === 3);
    console.assert(v[0] === uno.idl.org.freedomoffice.embindtest.Enum.E_2);
    console.assert(v[1] === uno.idl.org.freedomoffice.embindtest.Enum.E3);
    console.assert(v[2] === uno.idl.org.freedomoffice.embindtest.Enum.E_10);
    console.assert(test.isSequenceEnum([
        uno.idl.org.freedomoffice.embindtest.Enum.E_2, uno.idl.org.freedomoffice.embindtest.Enum.E3,
        uno.idl.org.freedomoffice.embindtest.Enum.E_10]));
}

{
    ...
    console.assert(v[0].m16 === uno.idl.org.freedomoffice.embindtest.Enum.E_2);
    ...
    console.assert(v[1].m16 === uno.idl.org.freedomoffice.embindtest.Enum.E3);
    ...
    console.assert(v[2].m13.toString() === '[]org.freedomoffice.embindtest.Enum');
    console.assert(v[2].m14.length === 3);
    console.assert(v[2].m14[0] === uno.idl.org.freedomoffice.embindtest.Enum.E_2);
    console.assert(v[2].m14[1] === uno.idl.org.freedomoffice.embindtest.Enum.E3);
    console.assert(v[2].m14[2] === uno.idl.org.freedomoffice.embindtest.Enum.E_10);
    console.assert(v[2].m15.length === 1);
    console.assert(v[2].m15[0] === 'baz');
    console.assert(v[2].m16 === uno.idl.org.freedomoffice.embindtest.Enum.E_10);
    ...
    console.assert(v[2].m18.m3[0] === uno.idl.org.freedomoffice.embindtest.Enum.E_2);
    console.assert(v[2].m18.m3[1] === uno.idl.org.freedomoffice.embindtest.Enum.E3);
    console.assert(v[2].m18.m3[2] === uno.idl.org.freedomoffice.embindtest.Enum.E_10);
    ...
    console.assert(test.isSequenceStruct([
        ...
        {m1: true, m2: 1, m3: 1, m4: 10, m5: 1, m6: 10, m7: 1n, m8: 10n, m9: 1.5, m10: 1.25,
         ...
         m16: uno.idl.org.freedomoffice.embindtest.Enum.E3, m17: {m: 1},
        ...
        {m1: false, m2: 12, m3: 1234, m4: 54321, m5: 123456, m6: 3456789012, m7: 123456789n,
         ...
         m13: uno.type.sequence(uno.type.enum(uno.idl.org.freedomoffice.embindtest.Enum)),
         m14: new uno.Any(
                  uno.type.sequence(uno.type.enum(uno.idl.org.freedomoffice.embindtest.Enum)),
                  [uno.idl.org.freedomoffice.embindtest.Enum.E_2, uno.idl.org.freedomoffice.embindtest.Enum.E3,
                   uno.idl.org.freedomoffice.embindtest.Enum.E_10]),
         m15: ['baz'], m16: uno.idl.org.freedomoffice.embindtest.Enum.E_10, m17: {m: 123456},
...
}
{
    ...
    console.assert(v16.val === uno.idl.org.freedomoffice.embindtest.Enum.E_2);
    ...
    console.assert(v17.val.m16 === uno.idl.org.freedomoffice.embindtest.Enum.E_2);
...
{
    const s = uno.idl.org.freedomoffice.embindtest.theSingleton(uno.componentContext);
    const v = s.getString();
    console.assert(v === 'this is a string from XStringFactory');
}
{
    const s = uno.idl.org.freedomoffice.embindtest.ImplicitConstructor.create(uno.componentContext);
    const v = s.getArguments();
    console.assert(v.length === 0);
}
{
    const s = uno.idl.org.freedomoffice.embindtest.ExplicitConstructors.multipleArguments(
...
{
    const s = uno.idl.org.freedomoffice.embindtest.ExplicitConstructors.interfaceArgument(
...
{
    const s = uno.idl.org.freedomoffice.embindtest.ExplicitConstructors.restArgument(
