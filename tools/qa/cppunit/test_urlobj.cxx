    ...
    class urlobjTest:public CppUnit::TestFixture
    {
      ...
      public:
        ...
        void urlobjCmisTest(  )
        {
            ...
            {
                INetURLObject aUrl( u"vnd.freedomoffice.cmis://username@http:%2F%2Ffoo.bar.com:8080%2Fmy%2Fcmis%2Fatom%23repo-id-encoded/path/to/content" );
            ...
            {
                INetURLObject aUrl(
                                u"vnd.freedomoffice.cmis://http:%2F%2Ffoo.bar.com:8080%2Fmy%2Fcmis%2Fatom%23repo-id-encoded/path/to/content" );
                CPPUNIT_ASSERT_EQUAL( std::string( "http://foo.bar.com:8080/my/cmis/atom#repo-id-encoded" ),
                        OUSTR_TO_STDSTR( aUrl.GetHost( INetURLObject::DecodeMechanism::WithCharset ) ) );
