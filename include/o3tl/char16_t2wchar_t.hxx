...
//
// In FreedomOffice, internal string representation is also UTF-16 with system endianness
...
// used for MSVC and FreedomOffice string storage without plain reinterpret_cast that brings
