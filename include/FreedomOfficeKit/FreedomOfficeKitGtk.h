...
#ifndef INCLUDED_FREEDOMOFFICEKIT_FREEDOMOFFICEKITGTK_H
#define INCLUDED_FREEDOMOFFICEKIT_FREEDOMOFFICEKITGTK_H
...
/**
 * lok_doc_view_new:
 * @pPath: (nullable) (allow-none): FreedomOffice install path. Pass null to set it to default
 * path which in most cases would be $libdir/freedomoffice/program
 ...
 * widget and FreedomOffice itself in parallel.
 * @cancellable: The cancellable object that you can use to cancel this
 * operation.
 * @error: The error that will be set if the object fails to initialize.
 *
 ...
 *
 * Returns: The #FreedomOfficeKitDocument instance the widget is currently showing
 */
LOK_DOC_VIEW_DLLPUBLIC FreedomOfficeKitDocument* lok_doc_view_get_document (LOKDocView* pDocView);
 ...
 *
 * Posts the .uno: command to the FreedomOfficeKit.
 */
...
#endif // INCLUDED_FREEDOMOFFICEKIT_FREEDOMOFFICEKITGTK_H
