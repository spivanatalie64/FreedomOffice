...
// Interface between the FreedomOfficeKit implementation called by FreedomOfficeKit clients and other
// FreedomOffice code.

namespace comphelper::FreedomOfficeKit
{
...
// Functions to be called only from the FreedomOfficeKit implementation in desktop, not from other
// places in FreedomOffice code.
...
// Functions that can be called from arbitrary places in FreedomOffice.

// Check whether the code is running as invoked through FreedomOfficeKit.
