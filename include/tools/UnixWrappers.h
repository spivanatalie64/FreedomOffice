 ...
 *
 * Of course, FreedomOffice has tons of APIs from before whose whole point is to hide system
 ...
 * written in C that we compile as part of FreedomOffice in some circumstances, particularly for
 * Windows.
 *
