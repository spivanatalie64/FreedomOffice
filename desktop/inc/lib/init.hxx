...
namespace desktop {
    ...
    {
    public:
        DESKTOP_DLLPUBLIC explicit CallbackFlushHandler(FreedomOfficeKitDocument* pDocument, FreedomOfficeKitCallback pCallback, void* pData);
    ...
    private:
        ...
        FreedomOfficeKitCallback m_pCallback;
    ...
    struct DESKTOP_DLLPUBLIC LibLODocument_Impl : public FreedomOfficeKitDocument
    {
        css::uno::Reference<css::lang::XComponent> mxComponent;
        std::shared_ptr< FreedomOfficeKitDocumentClass > m_pDocumentClass;
    ...
    struct DESKTOP_DLLPUBLIC LibFreedomOffice_Impl : public FreedomOfficeKit
    {
        OUString maLastExceptionMsg;
        std::shared_ptr< FreedomOfficeKitClass > m_pOfficeClass;
        oslThread maThread;
        FreedomOfficeKitCallback mpCallback;
        void *mpCallbackData;
        int64_t mOptionalFeatures;
        std::map<OString, rtl::Reference<LOKInteractionHandler>> mInteractionMap;

        LibFreedomOffice_Impl();
        ~LibFreedomOffice_Impl();

        bool hasOptionalFeature(FreedomOfficeKitOptionalFeatures const feature)
        {
