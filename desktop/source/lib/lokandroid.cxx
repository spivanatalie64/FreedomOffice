...
extern "C" SAL_JNI_EXPORT jstring JNICALL Java_org_freedomoffice_kit_Office_getError
    (JNIEnv* pEnv, jobject aObject)
{
    FreedomOfficeKit* pFreedomOfficeKit = getHandle<FreedomOfficeKit>(pEnv, aObject);
    char* pError = pFreedomOfficeKit->pClass->getError(pFreedomOfficeKit);
    return pEnv->NewStringUTF(pError);
}

extern "C" SAL_JNI_EXPORT void JNICALL Java_org_freedomoffice_kit_Office_destroy
    (JNIEnv* pEnv, jobject aObject)
{
    FreedomOfficeKit* pFreedomOfficeKit = getHandle<FreedomOfficeKit>(pEnv, aObject);
    pFreedomOfficeKit->pClass->destroy(pFreedomOfficeKit);
}

extern "C" SAL_JNI_EXPORT void JNICALL Java_org_freedomoffice_kit_Office_destroyAndExit(JNIEnv* pEnv, jobject aObject)
{
    FreedomOfficeKit* pFreedomOfficeKit = getHandle<FreedomOfficeKit>(pEnv, aObject);
    pFreedomOfficeKit->pClass->destroy(pFreedomOfficeKit);
...
extern "C" SAL_JNI_EXPORT jobject JNICALL Java_org_freedomoffice_kit_Office_documentLoadNative
    (JNIEnv* pEnv, jobject aObject, jstring documentPath)
{
    const char* aCloneDocumentPath = copyJavaString(pEnv, documentPath);
    FreedomOfficeKit* pFreedomOfficeKit = getHandle<FreedomOfficeKit>(pEnv, aObject);

    FreedomOfficeKitDocument* pDocument = pFreedomOfficeKit->pClass->documentLoad(pFreedomOfficeKit, aCloneDocumentPath);

    if (pDocument == NULL)
        return NULL;

    jobject aHandle = pEnv->NewDirectByteBuffer((void*) pDocument, sizeof(FreedomOfficeKitDocument));

    return aHandle;
}

extern "C" SAL_JNI_EXPORT void JNICALL Java_org_freedomoffice_kit_Office_setDocumentPassword
    (JNIEnv* pEnv, jobject aObject, jstring sUrl, jstring sPassword)
{
    ...
    if (sPassword == NULL) {
        pFreedomOfficeKit->pClass->setDocumentPassword(pFreedomOfficeKit, pUrl, nullptr);
    } else {
        char const* pPassword = copyJavaString(pEnv, sPassword);
        pFreedomOfficeKit->pClass->setDocumentPassword(pFreedomOfficeKit, pUrl, pPassword);
    }
}

extern "C" SAL_JNI_EXPORT void JNICALL Java_org_freedomoffice_kit_Office_setOptionalFeatures
    (JNIEnv* pEnv, jobject aObject, jlong options)
{
    ...
    pFreedomOfficeKit->pClass->setOptionalFeatures(pFreedomOfficeKit, pOptions);
}

/** Implementation of org.freedomoffice.kit.Office.bindMessageCallback method */
extern "C" SAL_JNI_EXPORT void JNICALL Java_org_freedomoffice_kit_Office_bindMessageCallback
    (JNIEnv* pEnv, jobject aObject)
{
    FreedomOfficeKit* pFreedomOfficeKit = getHandle<FreedomOfficeKit>(pEnv, aObject);
    ...
    pFreedomOfficeKit->pClass->registerCallback(pFreedomOfficeKit, messageCallback, (void*) &gCallbackDataLOKit);
}

/* Document */

/** Implementation of org.freedomoffice.kit.Document.bindMessageCallback method */
extern "C" SAL_JNI_EXPORT void JNICALL Java_org_freedomoffice_kit_Document_bindMessageCallback
    (JNIEnv* pEnv, jobject aObject)
{
    FreedomOfficeKitDocument* pDocument = getHandle<FreedomOfficeKitDocument>(pEnv, aObject);
...
extern "C" SAL_JNI_EXPORT void JNICALL Java_org_freedomoffice_kit_Document_destroy
    (JNIEnv* pEnv, jobject aObject)
{
    FreedomOfficeKitDocument* pDocument = getHandle<FreedomOfficeKitDocument>(pEnv, aObject);
...
extern "C" SAL_JNI_EXPORT void JNICALL Java_org_freedomoffice_kit_Document_setPart
...
extern "C" SAL_JNI_EXPORT jint JNICALL Java_org_freedomoffice_kit_Document_getPart
    (JNIEnv* pEnv, jobject aObject)
{
    FreedomOfficeKitDocument* pDocument = getHandle<FreedomOfficeKitDocument>(pEnv, aObject);
...
extern "C" SAL_JNI_EXPORT jstring JNICALL Java_org_freedomoffice_kit_Document_getPartPageRectangles
    (JNIEnv* pEnv, jobject aObject)
{
    FreedomOfficeKitDocument* pDocument = getHandle<FreedomOfficeKitDocument>(pEnv, aObject);
...
extern "C" SAL_JNI_EXPORT jint JNICALL Java_org_freedomoffice_kit_Document_getParts
    (JNIEnv* pEnv, jobject aObject)
{
    FreedomOfficeKitDocument* pDocument = getHandle<FreedomOfficeKitDocument>(pEnv, aObject);
...
extern "C" SAL_JNI_EXPORT jstring JNICALL Java_org_freedomoffice_kit_Document_getPartName
...
extern "C" SAL_JNI_EXPORT void JNICALL Java_org_freedomoffice_kit_Document_setPartMode
...
extern "C" SAL_JNI_EXPORT jint JNICALL Java_org_freedomoffice_kit_Document_getDocumentTypeNative
    (JNIEnv* pEnv, jobject aObject)
{
    FreedomOfficeKitDocument* pDocument = getHandle<FreedomOfficeKitDocument>(pEnv, aObject);
...
extern "C" SAL_JNI_EXPORT void JNICALL Java_org_freedomoffice_kit_Document_paintTileNative
...
extern "C" SAL_JNI_EXPORT jlong JNICALL Java_org_freedomoffice_kit_Document_getDocumentHeight
    (JNIEnv* pEnv, jobject aObject)
{
    FreedomOfficeKitDocument* pDocument = getHandle<FreedomOfficeKitDocument>(pEnv, aObject);
    long nWidth;
...
extern "C" SAL_JNI_EXPORT jlong JNICALL Java_org_freedomoffice_kit_Document_getDocumentWidth
    (JNIEnv* pEnv, jobject aObject)
{
    FreedomOfficeKitDocument* pDocument = getHandle<FreedomOfficeKitDocument>(pEnv, aObject);
    long nWidth;
...
extern "C" SAL_JNI_EXPORT void JNICALL Java_org_freedomoffice_kit_Document_initializeForRendering
    (JNIEnv* pEnv, jobject aObject)
{
    FreedomOfficeKitDocument* pDocument = getHandle<FreedomOfficeKitDocument>(pEnv, aObject);
...
extern "C" SAL_JNI_EXPORT jint JNICALL Java_org_freedomoffice_kit_Document_saveAs
...
extern "C" SAL_JNI_EXPORT void JNICALL Java_org_freedomoffice_kit_Document_postKeyEvent
...
extern "C" SAL_JNI_EXPORT void JNICALL Java_org_freedomoffice_kit_Document_postMouseEvent
...
extern "C" SAL_JNI_EXPORT void JNICALL Java_org_freedomoffice_kit_Document_postUnoCommand
...
extern "C" SAL_JNI_EXPORT void JNICALL Java_org_freedomoffice_kit_Document_setTextSelection
...
extern "C" SAL_JNI_EXPORT jstring JNICALL Java_org_freedomoffice_kit_Document_getTextSelection
    (JNIEnv* pEnv, jobject aObject, jstring mimeType)
{
    ...
    FreedomOfficeKitDocumentClass* pcls = pDocument->pClass;
...
extern "C" SAL_JNI_EXPORT jboolean JNICALL Java_org_freedomoffice_kit_Document_paste
...
extern "C" SAL_JNI_EXPORT void JNICALL Java_org_freedomoffice_kit_Document_setGraphicSelection
    (JNIEnv* pEnv, jobject aObject, jint type, jint x, jint y)
{
    FreedomOfficeKitDocument* pDocument = getHandle<FreedomOfficeKitDocument>(pEnv, aObject);
...
extern "C" SAL_JNI_EXPORT void JNICALL Java_org_freedomoffice_kit_Document_resetSelection
    (JNIEnv* pEnv, jobject aObject)
{
    FreedomOfficeKitDocument* pDocument = getHandle<FreedomOfficeKitDocument>(pEnv, aObject);
...
extern "C" SAL_JNI_EXPORT jstring JNICALL Java_org_freedomoffice_kit_Document_getCommandValues
...
extern "C" SAL_JNI_EXPORT void JNICALL Java_org_freedomoffice_kit_Document_setClientZoom
