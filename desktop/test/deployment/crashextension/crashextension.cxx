...
{
    return rtl::OUString("org.freedomoffice.test.desktop.deployment.crashextension.impl");
}

css::uno::Sequence<rtl::OUString> Provider::static_getSupportedServiceNames()
{
    rtl::OUString name("org.freedomoffice.test.desktop.deployment.crashextension");
