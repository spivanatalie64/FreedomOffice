...
$(eval $(call gb_Module_add_targets,desktop,\
    ...
    $(if $(filter MACOSX,$(OS)),CustomTarget_freedomoffice) \
))

ifneq (,$(filter-out EMSCRIPTEN HAIKU MACOSX WNT,$(OS)))
$(eval $(call gb_Module_add_targets,desktop,\
    Package_freedomoffice_sh \
))
endif

ifeq ($(USING_X11), TRUE)
$(eval $(call gb_Module_add_targets,desktop,\
    Package_freedombase_sh \
    Package_freedomsheet_sh \
    Package_freedomdraw_sh \
    Package_freedomshow_sh \
    Package_freedomequation_sh \
    Package_freedomwriter_sh \
))
endif
endif # DESKTOP
...
$(eval $(call gb_Module_add_targets,desktop,\
    ...
    Executable_freedombase \
    Executable_freedomsheet \
    Executable_freedomdraw \
    Executable_freedomshow \
    Executable_freedomequation \
    Executable_freedomoffice_exe \
    Executable_freedomoffice_com \
    Executable_freedomoffice_safe \
    Executable_sweb \
    Executable_freedomwriter \
    Executable_unoinfo \
    ...
    WinResTarget_freedombase \
    WinResTarget_freedomsheet \
    WinResTarget_freedomdraw \
    WinResTarget_freedomshow \
    WinResTarget_freedomoffice \
    WinResTarget_freedomofficebin \
    WinResTarget_freedomequation \
    WinResTarget_sweb \
    WinResTarget_freedomwriter \
))
...
ifeq ($(OS),EMSCRIPTEN)
$(eval $(call gb_Module_add_targets,desktop, \
    CustomTarget_freedomoffice_bin-emscripten-exports \
))
endif
