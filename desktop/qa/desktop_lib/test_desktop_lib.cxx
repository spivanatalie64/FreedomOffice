...
static FreedomOfficeKitDocumentType getDocumentTypeFromName(std::string_view name)
{
...
public:
    ...
    {
        comphelper::FreedomOfficeKit::setActive(true);
    ...
    virtual void tearDown() override
    {
        ...
        comphelper::FreedomOfficeKit::setActive(false);
    }

    std::unique_ptr<LibLODocument_Impl>
    loadDocImpl(const char* pName, FreedomOfficeKitDocumentType eType);
...
public:
    std::unique_ptr<LibLODocument_Impl>
    loadDocUrlImpl(const OUString& rFileURL, FreedomOfficeKitDocumentType eType);

    LibLODocument_Impl* loadDocUrl(const OUString& rFileURL, FreedomOfficeKitDocumentType eType);
    LibLODocument_Impl* loadDoc(const char* pName, FreedomOfficeKitDocumentType eType);
...
std::unique_ptr<LibLODocument_Impl>
DesktopLOKTest::loadDocUrlImpl(const OUString& rFileURL, FreedomOfficeKitDocumentType eType)
{
    OUString aService;
    switch (eType)
    {
    ...
    comphelper::FreedomOfficeKit::setDocId(ViewShellDocId(nDocumentIdCounter));
...
std::unique_ptr<LibLODocument_Impl>
DesktopLOKTest::loadDocImpl(const char* pName, FreedomOfficeKitDocumentType eType)
{
...
LibLODocument_Impl* DesktopLOKTest::loadDocUrl(const OUString& rFileURL, FreedomOfficeKitDocumentType eType)
{
    m_pDocument = loadDocUrlImpl(rFileURL, eType);
    return m_pDocument.get();
}

LibLODocument_Impl* DesktopLOKTest::loadDoc(const char* pName, FreedomOfficeKitDocumentType eType)
{
...
void DesktopLOKTest::testTileInvalidationCompression()
{
    ...
    {
        comphelper::FreedomOfficeKit::setPartInInvalidation(false);
    });
...
void DesktopLOKTest::testCommentsWriter()
{
    ...
    comphelper::FreedomOfficeKit::setTiledAnnotations(true);
}
...
void DesktopLOKTest::testSpellcheckerMultiView()
{
    ...
    comphelper::FreedomOfficeKit::setLanguageTag(LanguageTag(aLangISO, true));
...
{
    return sizeof(static_cast<FreedomOfficeKitClass*>(nullptr)->nSize) + i * sizeof(void*);
}

constexpr size_t documentClassOffset(int i)
{
    return sizeof(static_cast<FreedomOfficeKitDocumentClass*>(nullptr)->nSize) + i * sizeof(void*);
}
...
void DesktopLOKTest::testABI()
{
    ...
    CPPUNIT_ASSERT_EQUAL(classOffset(0), offsetof(FreedomOfficeKitClass, destroy));
    CPPUNIT_ASSERT_EQUAL(classOffset(1), offsetof(FreedomOfficeKitClass, documentLoad));
    CPPUNIT_ASSERT_EQUAL(classOffset(2), offsetof(FreedomOfficeKitClass, getError));
    CPPUNIT_ASSERT_EQUAL(classOffset(3), offsetof(FreedomOfficeKitClass, documentLoadWithOptions));
    CPPUNIT_ASSERT_EQUAL(classOffset(4), offsetof(FreedomOfficeKitClass, freeError));
    CPPUNIT_ASSERT_EQUAL(classOffset(5), offsetof(FreedomOfficeKitClass, registerCallback));
    CPPUNIT_ASSERT_EQUAL(classOffset(6), offsetof(FreedomOfficeKitClass, getFilterTypes));
    CPPUNIT_ASSERT_EQUAL(classOffset(7), offsetof(FreedomOfficeKitClass, setOptionalFeatures));
    CPPUNIT_ASSERT_EQUAL(classOffset(8), offsetof(FreedomOfficeKitClass, setDocumentPassword));
    CPPUNIT_ASSERT_EQUAL(classOffset(9), offsetof(FreedomOfficeKitClass, getVersionInfo));
    CPPUNIT_ASSERT_EQUAL(classOffset(10), offsetof(FreedomOfficeKitClass, runMacro));
    CPPUNIT_ASSERT_EQUAL(classOffset(11), offsetof(FreedomOfficeKitClass, signDocument));
    CPPUNIT_ASSERT_EQUAL(classOffset(12), offsetof(FreedomOfficeKitClass, runLoop));
    CPPUNIT_ASSERT_EQUAL(classOffset(13), offsetof(FreedomOfficeKitClass, setOption));
    CPPUNIT_ASSERT_EQUAL(classOffset(14), offsetof(FreedomOfficeKitClass, dumpState));
    CPPUNIT_ASSERT_EQUAL(classOffset(15), offsetof(FreedomOfficeKitClass, extractRequest));
    CPPUNIT_ASSERT_EQUAL(classOffset(16), offsetof(FreedomOfficeKitClass, trimMemory));
    CPPUNIT_ASSERT_EQUAL(classOffset(17), offsetof(FreedomOfficeKitClass, startURP));
    CPPUNIT_ASSERT_EQUAL(classOffset(18), offsetof(FreedomOfficeKitClass, stopURP));
    CPPUNIT_ASSERT_EQUAL(classOffset(19), offsetof(FreedomOfficeKitClass, joinThreads));
    CPPUNIT_ASSERT_EQUAL(classOffset(20), offsetof(FreedomOfficeKitClass, startThreads));
    CPPUNIT_ASSERT_EQUAL(classOffset(21), offsetof(FreedomOfficeKitClass, setForkedChild));
    CPPUNIT_ASSERT_EQUAL(classOffset(22), offsetof(FreedomOfficeKitClass, extractDocumentStructureRequest));
    CPPUNIT_ASSERT_EQUAL(classOffset(23), offsetof(FreedomOfficeKitClass, registerAnyInputCallback));
    CPPUNIT_ASSERT_EQUAL(classOffset(24), offsetof(FreedomOfficeKitClass, getDocsCount));
    CPPUNIT_ASSERT_EQUAL(classOffset(25), offsetof(FreedomOfficeKitClass, registerFileSaveDialogCallback));

    // When extending FreedomOfficeKit with a new function pointer,  add new assert for the offsetof the
    // new function pointer and bump this assert for the size of the class.
    CPPUNIT_ASSERT_EQUAL(classOffset(26), sizeof(FreedomOfficeKitClass));

    CPPUNIT_ASSERT_EQUAL(documentClassOffset(0), offsetof(FreedomOfficeKitDocumentClass, destroy));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(1), offsetof(FreedomOfficeKitDocumentClass, saveAs));
    ...
    // release?
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(2), offsetof(FreedomOfficeKitDocumentClass, getDocumentType));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(3), offsetof(FreedomOfficeKitDocumentClass, getParts));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(4), offsetof(FreedomOfficeKitDocumentClass, getPartPageRectangles));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(5), offsetof(FreedomOfficeKitDocumentClass, getPart));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(6), offsetof(FreedomOfficeKitDocumentClass, setPart));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(7), offsetof(FreedomOfficeKitDocumentClass, getPartName));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(8), offsetof(FreedomOfficeKitDocumentClass, setPartMode));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(9), offsetof(FreedomOfficeKitDocumentClass, paintTile));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(10), offsetof(FreedomOfficeKitDocumentClass, getTileMode));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(11), offsetof(FreedomOfficeKitDocumentClass, getDocumentSize));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(12), offsetof(FreedomOfficeKitDocumentClass, initializeForRendering));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(13), offsetof(FreedomOfficeKitDocumentClass, registerCallback));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(14), offsetof(FreedomOfficeKitDocumentClass, postKeyEvent));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(15), offsetof(FreedomOfficeKitDocumentClass, postMouseEvent));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(16), offsetof(FreedomOfficeKitDocumentClass, postUnoCommand));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(17), offsetof(FreedomOfficeKitDocumentClass, setTextSelection));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(18), offsetof(FreedomOfficeKitDocumentClass, getTextSelection));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(19), offsetof(FreedomOfficeKitDocumentClass, paste));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(20), offsetof(FreedomOfficeKitDocumentClass, setGraphicSelection));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(21), offsetof(FreedomOfficeKitDocumentClass, resetSelection));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(22), offsetof(FreedomOfficeKitDocumentClass, getCommandValues));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(23), offsetof(FreedomOfficeKitDocumentClass, setClientZoom));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(24), offsetof(FreedomOfficeKitDocumentClass, setClientVisibleArea));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(25), offsetof(FreedomOfficeKitDocumentClass, createView));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(26), offsetof(FreedomOfficeKitDocumentClass, destroyView));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(27), offsetof(FreedomOfficeKitDocumentClass, setView));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(28), offsetof(FreedomOfficeKitDocumentClass, getView));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(29), offsetof(FreedomOfficeKitDocumentClass, getViewsCount));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(30), offsetof(FreedomOfficeKitDocumentClass, renderFont));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(31), offsetof(FreedomOfficeKitDocumentClass, getPartHash));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(32), offsetof(FreedomOfficeKitDocumentClass, paintPartTile));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(33), offsetof(FreedomOfficeKitDocumentClass, getViewIds));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(34), offsetof(FreedomOfficeKitDocumentClass, setOutlineState));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(35), offsetof(FreedomOfficeKitDocumentClass, paintWindow));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(36), offsetof(FreedomOfficeKitDocumentClass, postWindow));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(37), offsetof(FreedomOfficeKitDocumentClass, postWindowKeyEvent));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(38), offsetof(FreedomOfficeKitDocumentClass, postWindowMouseEvent));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(39), offsetof(FreedomOfficeKitDocumentClass, setViewLanguage));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(40), offsetof(FreedomOfficeKitDocumentClass, postWindowExtTextInputEvent));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(41), offsetof(FreedomOfficeKitDocumentClass, getPartInfo));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(42), offsetof(FreedomOfficeKitDocumentClass, paintWindowDPI));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(43), offsetof(FreedomOfficeKitDocumentClass, insertCertificate));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(44), offsetof(FreedomOfficeKitDocumentClass, addCertificate));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(45), offsetof(FreedomOfficeKitDocumentClass, getSignatureState));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(46), offsetof(FreedomOfficeKitDocumentClass, renderShapeSelection));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(47), offsetof(FreedomOfficeKitDocumentClass, postWindowGestureEvent));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(48), offsetof(FreedomOfficeKitDocumentClass, createViewWithOptions));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(49), offsetof(FreedomOfficeKitDocumentClass, selectPart));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(50), offsetof(FreedomOfficeKitDocumentClass, moveSelectedParts));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(51), offsetof(FreedomOfficeKitDocumentClass, resizeWindow));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(52), offsetof(FreedomOfficeKitDocumentClass, getClipboard));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(53), offsetof(FreedomOfficeKitDocumentClass, setClipboard));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(54), offsetof(FreedomOfficeKitDocumentClass, getSelectionType));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(55), offsetof(FreedomOfficeKitDocumentClass, removeTextContext));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(56), offsetof(FreedomOfficeKitDocumentClass, renderFontOrientation));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(57), offsetof(FreedomOfficeKitDocumentClass, paintWindowForView));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(58), offsetof(FreedomOfficeKitDocumentClass, completeFunction));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(59), offsetof(FreedomOfficeKitDocumentClass, setWindowTextSelection));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(60), offsetof(FreedomOfficeKitDocumentClass, sendFormFieldEvent));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(61), offsetof(FreedomOfficeKitDocumentClass, setBlockedCommandList));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(62), offsetof(FreedomOfficeKitDocumentClass, renderSearchResult));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(63), offsetof(FreedomOfficeKitDocumentClass, sendContentControlEvent));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(64), offsetof(FreedomOfficeKitDocumentClass, getSelectionTypeAndText));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(65), offsetof(FreedomOfficeKitDocumentClass, getDataArea));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(66), offsetof(FreedomOfficeKitDocumentClass, getEditMode));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(67), offsetof(FreedomOfficeKitDocumentClass, setViewTimezone));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(68), offsetof(FreedomOfficeKitDocumentClass, setAccessibilityState));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(69), offsetof(FreedomOfficeKitDocumentClass, getA11yFocusedParagraph));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(70), offsetof(FreedomOfficeKitDocumentClass, getA11yCaretPosition));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(71), offsetof(FreedomOfficeKitDocumentClass, setViewReadOnly));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(72), offsetof(FreedomOfficeKitDocumentClass, getPresentationInfo));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(73), offsetof(FreedomOfficeKitDocumentClass, createSlideRenderer));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(74), offsetof(FreedomOfficeKitDocumentClass, postSlideshowCleanup));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(75), offsetof(FreedomOfficeKitDocumentClass, renderNextSlideLayer));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(76), offsetof(FreedomOfficeKitDocumentClass, setViewOption));
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(77), offsetof(FreedomOfficeKitDocumentClass, setColorPreviewState));

    // As above
    CPPUNIT_ASSERT_EQUAL(documentClassOffset(78), sizeof(FreedomOfficeKitDocumentClass));
}
