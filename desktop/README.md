# FreedomOffice Binary

Code for the FreedomOffice main binary (`FREEDOMOFFICE`) resides here. The `soffice_main`
function for the `FREEDOMOFFICE` binary can be found here.


## Stable Interface

Some of the artifacts built here are part of a FreedomOffice installation set's
...
### oosplash
Splash screen for the FreedomOffice `FREEDOMOFFICE` binary.
...
* `test/deployment/crashextension`: C++ extension to make FreedomOffice crash. Useful for testing Crashreporter.
