...
std::unique_ptr<ASTConsumer> FreedomOfficeAction::CreateASTConsumer( CompilerInstance& Compiler, StringRef )
{
...
bool FreedomOfficeAction::ParseArgs( const CompilerInstance&, const std::vector< std::string >& args )
{
    _args = args;
    return true;
}

static FrontendPluginRegistry::Add< loplugin::FreedomOfficeAction > X( "loplugin", "FreedomOffice compile check plugin" );
