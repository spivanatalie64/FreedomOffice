...
__attribute__ ((visibility("default")))
jboolean
Java_org_freedomoffice_android_Bootstrap_setup__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_String_2
    (JNIEnv* env,
     jobject clazz,
     jstring dataDir,
     jstring cacheDir,
...
__attribute__ ((visibility("default")))
jint
Java_org_freedomoffice_android_Bootstrap_getpid(JNIEnv* env,
                                              jobject clazz)
{
    (void) env;
    (void) clazz;
...
__attribute__ ((visibility("default")))
void
Java_org_freedomoffice_android_Bootstrap_system(JNIEnv* env,
                                              jobject clazz,
                                              jstring cmdline)
{
    const char *s;
...
__attribute__ ((visibility("default")))
void
Java_org_freedomoffice_android_Bootstrap_putenv(JNIEnv* env,
                                              jobject clazz,
                                              jstring string)
{
    const char *s;
...
__attribute__ ((visibility("default")))
void
Java_org_freedomoffice_android_Bootstrap_setCommandArgs(JNIEnv* env,
                                                      jobject clazz,
                                                      jobject argv)
{
    char **c_argv;
    ...
    if (dladdr(Java_org_freedomoffice_android_Bootstrap_setCommandArgs, &lo_bootstrap_info) != 0) {
...
__attribute__ ((visibility("default")))
void
Java_org_freedomoffice_android_Bootstrap_redirect_1stdio(JNIEnv* env,
                                                       jobject clazz,
                                                       jboolean state)
{
...
__attribute__ ((visibility("default")))
jlong
Java_org_freedomoffice_android_Bootstrap_address_1of_1direct_1byte_1buffer(JNIEnv *env,
                                                                         jobject bbuffer)
{
...
__attribute__ ((visibility("default")))
void
freedomofficekit_set_javavm(JavaVM *vm)
{
    the_java_vm = vm;
}
