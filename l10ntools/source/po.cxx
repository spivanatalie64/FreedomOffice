...
/** Container of po entry
    ...
    Provide all file operations related to FreedomOffice specific
    ...
    , m_bIsInitialized( false )
{
    ...
    m_pGenPo->setMsgStr(
        ...
        "Report-Msgid-Bugs-To: https://bugs.freedomoffice.org/enter_bug.cgi?"
        "product=FreedomOffice&bug_status=UNCONFIRMED&component=UI\n"
...
void PoIfstream::open(const OString& rFileName, OString* pPoHeader)
{
    ...
    while( !sTemp.empty() && !m_aInPut.eof() )
    {
        ...
        if (sTemp.starts_with("\"PO-Revision-Date"))
            ...
            *pPoHeader += "X-Generator: FreedomOffice\n";
