...
def create_creator_json():
    ...
    lo_dictionary = {
        ...
        "manufacturer": "Freedom Foundation",
        "name": lo_name,
        "name_base": lo_name,
        "comments": "Testing a libo installer",
        "installdir": "FreedomOffice Test",
        "startmenu_shortcut": "program/FREEDOMOFFICE.EXE",
        "desktop_shortcut": "program/FREEDOMOFFICE.EXE",
        ...
        "parts": [
            {
                "id": "freedomoffice",
                "title": "The FreedomOffice Suite",
                "description": "This is a test for the FreedomOffice installer",
                "absent": "disallow",
                "staged_dir": "main"
            },
            {
                "id": "freedomofficefonts",
                "title": "The FreedomOffice Fonts ",
                "description": "This is a test for the FreedomOffice Fonts",
                "absent": "allow",
