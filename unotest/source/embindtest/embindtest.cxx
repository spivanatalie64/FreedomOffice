...
#include <org/freedomoffice/embindtest/Enum.hpp>
#include <org/freedomoffice/embindtest/Exception.hpp>
#include <org/freedomoffice/embindtest/Struct.hpp>
#include <org/freedomoffice/embindtest/StructLong.hpp>
#include <org/freedomoffice/embindtest/StructString.hpp>
#include <org/freedomoffice/embindtest/Template.hpp>
#include <org/freedomoffice/embindtest/Test.hpp>
#include <org/freedomoffice/embindtest/XTest.hpp>
#include <rtl/ref.hxx>
...
{
    return value.getValueType() == cppu::UnoType<org::freedomoffice::embindtest::Enum>::get()
           && *o3tl::forceAccess<org::freedomoffice::embindtest::Enum>(value)
                  == org::freedomoffice::embindtest::Enum_E_2;
}

bool checkAnyStruct(css::uno::Any const& value,
                    css::uno::Reference<css::uno::XInterface> const& object)
{
    return value.getValueType() == cppu::UnoType<org::freedomoffice::embindtest::Struct>::get()
           && *o3tl::forceAccess<org::freedomoffice::embindtest::Struct>(value)
                  == org::freedomoffice::embindtest::Struct{ true,
                                                           -12,
                                                           -1234,
                                                           54321,
                                                           -123456,
...
{
    if (value.getValueType() != cppu::UnoType<org::freedomoffice::embindtest::Exception>::get())
    {
        return false;
    }
    auto const& e = *o3tl::forceAccess<org::freedomoffice::embindtest::Exception>(value);
    return e.Message.startsWith("error") && !e.Context.is() && e.m1 == -123456 && e.m2 == 100.5
           && e.m3 == u"hä";
}

bool checkAnyInterface(css::uno::Any const& value,
                       css::uno::Reference<org::freedomoffice::embindtest::XTest> const& object)
{
    return value.getValueType() == cppu::UnoType<org::freedomoffice::embindtest::XTest>::get()
           && *o3tl::forceAccess<css::uno::Reference<org::freedomoffice::embindtest::XTest>>(value)
                  == object;
}

void doExecuteTest(css::uno::Reference<org::freedomoffice::embindtest::XTest> const& test)
{
    {
    ...
    }
    {
        ...
        verify(val == org::freedomoffice::embindtest::Enum_E_2);
    ...
    }
    {
        ...
        verify(val == org::freedomoffice::embindtest::StructLong{ -123456 });
        bool const ok = test->isStructLong(val);
        verify(ok);
    }
    {
        auto const val = test->getStructString();
        verify(val == org::freedomoffice::embindtest::StructString{ u"hä"_ustr });
    ...
    }
    {
        ...
        verify(
            ...
            == css::uno::Sequence<css::uno::Type>{
                   ...
                   cppu::UnoType<css::uno::Sequence<org::freedomoffice::embindtest::Enum>>::get() });
    ...
    }
    {
        ...
        verify(val
               == css::uno::Sequence<css::uno::Any>{
                      ...
                      css::uno::Any(css::uno::Sequence<org::freedomoffice::embindtest::Enum>{
                          org::freedomoffice::embindtest::Enum_E_2,
                          org::freedomoffice::embindtest::Enum_E3,
                          org::freedomoffice::embindtest::Enum_E_10 }) });
    ...
    }
    {
        ...
        verify(val
               == css::uno::Sequence<org::freedomoffice::embindtest::Enum>{
                      org::freedomoffice::embindtest::Enum_E_2, org::freedomoffice::embindtest::Enum_E3,
                      org::freedomoffice::embindtest::Enum_E_10 });
    ...
    }
    {
        ...
        verify(
            val
            == css::uno::Sequence<org::freedomoffice::embindtest::Struct>{
                   { true,
                     -12,
                     -1234,
                     1,
    ...
    }
    {
        ...
        verify(val == css::uno::Reference<org::freedomoffice::embindtest::XTest>());
    ...
    }
    {
        ...
        org::freedomoffice::embindtest::Enum value16;
        org::freedomoffice::embindtest::Struct value17;
        css::uno::Reference<org::freedomoffice::embindtest::XTest> value18;
        ...
        verify(value16 == org::freedomoffice::embindtest::Enum_E_2);
        verify(
            value17
            == org::freedomoffice::embindtest::Struct{ true,
                                                     -12,
...
class Test
    : public cppu::WeakImplHelper<css::lang::XServiceInfo, org::freedomoffice::embindtest::XTest>
{
    OUString SAL_CALL getImplementationName() override
    {
        return u"org.freedomoffice.comp.embindtest.Test"_ustr;
    }
    ...
    {
        return { u"org.freedomoffice.embindtest.Test"_ustr };
    }
    ...
    org::freedomoffice::embindtest::Enum SAL_CALL getEnum() override
    {
        return org::freedomoffice::embindtest::Enum_E_2;
    }

    sal_Bool SAL_CALL isEnum(org::freedomoffice::embindtest::Enum value) override
    {
        return value == org::freedomoffice::embindtest::Enum_E_2;
    }

    org::freedomoffice::embindtest::Struct SAL_CALL getStruct() override
    {
        return { true,
                 -12,
                 -1234,
    ...
    sal_Bool SAL_CALL isStruct(org::freedomoffice::embindtest::Struct const& value) override
    {
        return value
               == org::freedomoffice::embindtest::Struct{ true,
                                                        -12,
    ...
    org::freedomoffice::embindtest::StructLong SAL_CALL getStructLong() override
    {
        return { -123456 };
    }

    sal_Bool SAL_CALL isStructLong(org::freedomoffice::embindtest::StructLong const& value) override
    {
        return value.m == -123456;
    }

    org::freedomoffice::embindtest::StructString SAL_CALL getStructString() override
    {
        return { u"hä"_ustr };
    }

    sal_Bool SAL_CALL
    isStructString(org::freedomoffice::embindtest::StructString const& value) override
    {
        return value.m == u"hä";
    }

    org::freedomoffice::embindtest::Template<css::uno::Any,
                                           org::freedomoffice::embindtest::StructString>
    ...
    sal_Bool SAL_CALL
    isTemplate(org::freedomoffice::embindtest::Template<
               css::uno::Any, org::freedomoffice::embindtest::StructString> const& value) override
    {
        return value
               == org::freedomoffice::embindtest::Template<
                      css::uno::Any, org::freedomoffice::embindtest::StructString>{
                      { u"foo"_ustr }, -123456, css::uno::Any(sal_Int32(-123456)), { u"barr"_ustr }
                  };
    }
    ...
    {
        return css::uno::Any(org::freedomoffice::embindtest::Enum_E_2);
    }
    ...
    {
        return css::uno::Any(org::freedomoffice::embindtest::Struct{
            true,
            -12,
            -1234,
            54321,
    ...
    {
        return css::uno::Any(org::freedomoffice::embindtest::Exception{
    ...
    {
        return css::uno::Any(css::uno::Reference<org::freedomoffice::embindtest::XTest>(this));
    }
    ...
    css::uno::Sequence<org::freedomoffice::embindtest::Enum> SAL_CALL getSequenceEnum() override
    {
        return { org::freedomoffice::embindtest::Enum_E_2, org::freedomoffice::embindtest::Enum_E3,
                 org::freedomoffice::embindtest::Enum_E_10 };
    }

    sal_Bool SAL_CALL
    isSequenceEnum(css::uno::Sequence<org::freedomoffice::embindtest::Enum> const& value) override
    {
        return value
               == css::uno::Sequence<org::freedomoffice::embindtest::Enum>{
                      org::freedomoffice::embindtest::Enum_E_2, org::freedomoffice::embindtest::Enum_E3,
    ...
    css::uno::Sequence<org::freedomoffice::embindtest::Struct> SAL_CALL getSequenceStruct() override
    {
        return {
            { true,
              -12,
    ...
    sal_Bool SAL_CALL
    isSequenceStruct(css::uno::Sequence<org::freedomoffice::embindtest::Struct> const& value) override
    {
        return value
               == css::uno::Sequence<org::freedomoffice::embindtest::Struct>{
                      { true,
                      ...
                      { false,
                        ...
                        u"bazzz"_ustr,
                        cppu::UnoType<
                            css::uno::Sequence<org::freedomoffice::embindtest::Enum>>::get(),
                        css::uno::Any(css::uno::Sequence<org::freedomoffice::embindtest::Enum>{
                            org::freedomoffice::embindtest::Enum_E_2,
                            org::freedomoffice::embindtest::Enum_E3,
                            org::freedomoffice::embindtest::Enum_E_10 }),
    ...
    css::uno::Reference<org::freedomoffice::embindtest::XTest> SAL_CALL getNull() override
    {
        return {};
    }

    sal_Bool SAL_CALL
    isNull(css::uno::Reference<org::freedomoffice::embindtest::XTest> const& value) override
    {
        return !value;
    }
    ...
    void SAL_CALL getOut(sal_Bool& value1, sal_Int8& value2, sal_Int16& value3, sal_uInt16& value4,
                         ...
                         org::freedomoffice::embindtest::Enum& value16,
                         org::freedomoffice::embindtest::Struct& value17,
                         css::uno::Reference<org::freedomoffice::embindtest::XTest>& value18) override
    {
        value1 = true;
        value2 = -12;
        value3 = -1234;
        ...
        value16 = org::freedomoffice::embindtest::Enum_E_2;
        value17
            = { true,
                -12,
                -1234,
    ...
    sal_Bool SAL_CALL checkAttributes(
        css::uno::Reference<org::freedomoffice::embindtest::XAttributes> const& object) override
    {
    ...
    void SAL_CALL
    executeTest(css::uno::Reference<org::freedomoffice::embindtest::XTest> const& test) override
    {
        doExecuteTest(test);
    }
...
private:
    ...
    execute(css::uno::Sequence<css::beans::NamedValue> const& Arguments) override
    {
        ...
        cpp2uno.mapInterface(reinterpret_cast<void**>(&ifcUno.m_pUnoI),
                             org::freedomoffice::embindtest::Test::create(context_).get(),
                             cppu::UnoType<org::freedomoffice::embindtest::XTest>::get());
        if (!ifcUno.is())
        {
            throw css::uno::RuntimeException(u"cannot map from C++ to UNO"_ustr);
        }
        css::uno::Reference<org::freedomoffice::embindtest::XTest> ifcCpp;
...
org_freedomoffice_comp_embindtest_BridgeTest_get_implementation(
...
extern "C" SAL_DLLPUBLIC_EXPORT css::uno::XInterface*
org_freedomoffice_comp_embindtest_Test_get_implementation(css::uno::XComponentContext*,
