...
Module.uno_init.then(function() {
    ...
    let test = Module.uno.org.freedomoffice.embindtest.Test.create(Module.getUnoComponentContext());
    ...
    }
    {
        let v = test.getEnum();
        console.log(v);
        console.assert(v === Module.uno.org.freedomoffice.embindtest.Enum.E_2);
    ...
    }
    {
        ...
        console.assert(v.m16 === Module.uno.org.freedomoffice.embindtest.Enum.E_2);
    ...
    }
    {
        ...
        console.log(v);
        console.assert(v.get() === Module.uno.org.freedomoffice.embindtest.Enum.E_2);
        console.assert(test.isAnyEnum(v));
        v.delete();
        let a = new Module.uno_Any(
            Module.uno_Type.Enum('org.freedomoffice.embindtest.Enum'),
            Module.uno.org.freedomoffice.embindtest.Enum.E_2);
    ...
    }
    {
        ...
        console.assert(v.get().m16 === Module.uno.org.freedomoffice.embindtest.Enum.E_2);
        ...
        let a = new Module.uno_Any(
            Module.uno_Type.Struct('org.freedomoffice.embindtest.Struct'),
            {m1: true, m2: -12, m3: -1234, m4: 54321, m5: -123456, m6: 3456789012, m7: -123456789n,
             ...
             m16: Module.uno.org.freedomoffice.embindtest.Enum.E_2, m17: {m: -123456},
    ...
    }
    {
        ...
        v.delete();
        let a = new Module.uno_Any(
            Module.uno_Type.Exception('org.freedomoffice.embindtest.Exception'),
    ...
    }
    {
        ...
        v.delete();
        let a = new Module.uno_Any(
            Module.uno_Type.Interface('org.freedomoffice.embindtest.XTest'), test);
    ...
    }
    {
        ...
        console.assert(v.get(2).toString() === '[]org.freedomoffice.embindtest.Enum');
        console.assert(test.isSequenceType(v));
        v.delete();
        let s = new Module.uno_Sequence_type([
            Module.uno_Type.Long(), Module.uno_Type.Void(),
            Module.uno_Type.Sequence(Module.uno_Type.Enum('org.freedomoffice.embindtest.Enum'))]);
    ...
    }
    {
        ...
        console.assert(s.get(0) === Module.uno.org.freedomoffice.embindtest.Enum.E_2);
        console.assert(s.get(1) === Module.uno.org.freedomoffice.embindtest.Enum.E3);
        console.assert(s.get(2) === Module.uno.org.freedomoffice.embindtest.Enum.E_10);
        s.delete();
        e2.delete();
    ...
    }
    {
        ...
        console.log(v);
        console.assert(v.size() === 3);
        console.assert(v.get(0) === Module.uno.org.freedomoffice.embindtest.Enum.E_2);
        console.assert(v.get(1) === Module.uno.org.freedomoffice.embindtest.Enum.E3);
        console.assert(v.get(2) === Module.uno.org.freedomoffice.embindtest.Enum.E_10);
    ...
    }
    {
        ...
        console.assert(v.get(0).m16 === Module.uno.org.freedomoffice.embindtest.Enum.E_2);
        ...
        console.assert(v.get(1).m16 === Module.uno.org.freedomoffice.embindtest.Enum.E3);
        ...
        console.assert(v.get(2).m13.toString() === '[]org.freedomoffice.embindtest.Enum');
        console.assert(v.get(2).m14.get().size() === 3);
        console.assert(
            v.get(2).m14.get().get(0) === Module.uno.org.freedomoffice.embindtest.Enum.E_2);
        console.assert(v.get(2).m14.get().get(1) === Module.uno.org.freedomoffice.embindtest.Enum.E3);
        console.assert(
            v.get(2).m14.get().get(2) === Module.uno.org.freedomoffice.embindtest.Enum.E_10);
        console.assert(v.get(2).m15.size() === 1);
        console.assert(v.get(2).m15.get(0) === 'baz');
        console.assert(v.get(2).m16 === Module.uno.org.freedomoffice.embindtest.Enum.E_10);
        ...
        console.assert(
            v.get(2).m18.m3.get().get(0) === Module.uno.org.freedomoffice.embindtest.Enum.E_2);
        console.assert(
            v.get(2).m18.m3.get().get(1) === Module.uno.org.freedomoffice.embindtest.Enum.E3);
        console.assert(
            v.get(2).m18.m3.get().get(2) === Module.uno.org.freedomoffice.embindtest.Enum.E_10);
    ...
    }
    {
        ...
        const v16 = new Module.uno_InOutParam_org$freedomoffice$embindtest$Enum;
        const v17 = new Module.uno_InOutParam_org$freedomoffice$embindtest$Struct;
        const v18 = new Module.uno_InOutParam_org$freedomoffice$embindtest$XTest;
        test.getOut(
        ...
        console.assert(v16.val === Module.uno.org.freedomoffice.embindtest.Enum.E_2);
        ...
        console.assert(v17.val.m16 === Module.uno.org.freedomoffice.embindtest.Enum.E_2);
    ...
    console.assert(Module.uno.org.freedomoffice.embindtest.Constants.Boolean === true);
    console.assert(test.isBoolean(Module.uno.org.freedomoffice.embindtest.Constants.Boolean));
    console.assert(Module.uno.org.freedomoffice.embindtest.Constants.Byte === -12);
    console.assert(test.isByte(Module.uno.org.freedomoffice.embindtest.Constants.Byte));
    console.assert(Module.uno.org.freedomoffice.embindtest.Constants.Short === -1234);
    console.assert(test.isShort(Module.uno.org.freedomoffice.embindtest.Constants.Short));
    console.assert(Module.uno.org.freedomoffice.embindtest.Constants.UnsignedShort === 54321);
    console.assert(
        test.isUnsignedShort(Module.uno.org.freedomoffice.embindtest.Constants.UnsignedShort));
    console.assert(Module.uno.org.freedomoffice.embindtest.Constants.Long === -123456);
    console.assert(test.isLong(Module.uno.org.freedomoffice.embindtest.Constants.Long));
    console.assert(Module.uno.org.freedomoffice.embindtest.Constants.UnsignedLong === 3456789012);
    console.assert(
        test.isUnsignedLong(Module.uno.org.freedomoffice.embindtest.Constants.UnsignedLong));
    console.assert(Module.uno.org.freedomoffice.embindtest.Constants.Hyper === -123456789n);
    console.assert(test.isHyper(Module.uno.org.freedomoffice.embindtest.Constants.Hyper));
    console.assert(Module.uno.org.freedomoffice.embindtest.Constants.UnsignedHyper === 9876543210n);
    console.assert(
        test.isUnsignedHyper(Module.uno.org.freedomoffice.embindtest.Constants.UnsignedHyper));
    console.assert(Module.uno.org.freedomoffice.embindtest.Constants.Float === -10.25);
    console.assert(test.isFloat(Module.uno.org.freedomoffice.embindtest.Constants.Float));
    console.assert(Module.uno.org.freedomoffice.embindtest.Constants.Double === 100.5);
    console.assert(test.isDouble(Module.uno.org.freedomoffice.embindtest.Constants.Double));
    try {
    ...
    const obj = Module.unoObject(
        ['com.sun.star.task.XJob', 'com.sun.star.task.XJobExecutor',
         'org.freedomoffice.embindtest.XAttributes'],
        {
            execute(args) {
        ...
        });
    {
        ...
        console.assert(s.get(3).toString() === 'org.freedomoffice.embindtest.XAttributes');
        s.delete();
    }
    {
    ...
    {
        const attrs = Module.uno.org.freedomoffice.embindtest.XAttributes.query(obj);
    ...
    }
    {
        ...
        const ret =
              Module.uno.org.freedomoffice.embindtest.BridgeTest(Module.getUnoComponentContext()).
              execute(args);
        args.delete();
