# FreedomOffice Licensing Blurb

Contains the stock freedomoffice licensing blurb, as distributed in the install
...
externals may or may not be shipped with FreedomOffice. Therefore, we need to pass
