...
{
    const wchar_t* keyPath = L"SOFTWARE\\FreedomOffice\\UNO\\InstallPath";
...
void CheckFileExtRegistration(weld::Window* pDialogParent)
{
    ...
    static const std::pair<LPCWSTR, LPCWSTR> formats[] = {
        { L".odp", L"FreedomOffice.ImpressDocument.1" },
        { L".odt", L"FreedomOffice.WriterDocument.1" },
        { L".ods", L"FreedomOffice.CalcDocument.1" },
    };
