...
void VclAnimationTest::testFrameCount()
{
    ...
    aAnimation.Insert(
        AnimationFrame(Bitmap(Size(3, 4), vcl::PixelFormat::N24_BPP), Point(0, 0), Size(3, 4)));
...
void VclAnimationTest::testDisplaySize()
{
    ...
    aAnimation.Insert(
        AnimationFrame(Bitmap(Size(10, 10), vcl::PixelFormat::N24_BPP), Point(0, 0), Size(10, 10)));
