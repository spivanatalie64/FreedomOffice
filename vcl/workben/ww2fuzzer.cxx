...
void IndexedPropertyValuesContainer_get_implementation(void);
...
void unoxml_rdfRepository_get_implementation(void);
void unoxml_CURI_get_implementation(void);
void unoxml_CLiteral_get_implementation(void);
void unoxml_CBlankNode_get_implementation(void);
void unoxml_CXPathAPI_get_implementation(void);
void unoxml_CSAXDocumentBuilder_get_implementation(void);
