...
void ThemeColors::SetThemeState(ThemeState eState)
{
    ...
    officecfg::Office::Common::Appearance::FreedomOfficeTheme::set(static_cast<int>(eState), pChange);
    pChange->commit();
}

ThemeState ThemeColors::GetThemeState()
{
    return static_cast<ThemeState>(officecfg::Office::Common::Appearance::FreedomOfficeTheme::get());
}
