...
OUString IconHelper::GetAppIconName(sal_uInt16 nIcon)
{
    switch (nIcon)
    {
        case SV_ICON_ID_TEXT:
            return u"freedomoffice-writer"_ustr;
        case SV_ICON_ID_SPREADSHEET:
            return u"freedomoffice-calc"_ustr;
        case SV_ICON_ID_DRAWING:
            return u"freedomoffice-draw"_ustr;
        case SV_ICON_ID_PRESENTATION:
            return u"freedomoffice-impress"_ustr;
        case SV_ICON_ID_DATABASE:
            return u"freedomoffice-base"_ustr;
        case SV_ICON_ID_FORMULA:
            return u"freedomoffice-math"_ustr;
        default:
            return u"freedomoffice-startcenter"_ustr;
    }
}
