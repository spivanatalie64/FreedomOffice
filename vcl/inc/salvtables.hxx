...
public:
    ...
    virtual void
    SetInstallLOKNotifierHdl(const Link<void*, vcl::IFreedomOfficeKitNotifier*>& rLink) override;
...
//ComboBox and ListBox have similar apis, ComboBoxes in FreedomOffice have an edit box and ListBoxes
